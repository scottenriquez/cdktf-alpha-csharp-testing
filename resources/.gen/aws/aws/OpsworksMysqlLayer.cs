...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.OpsworksMysqlLayer), fullyQualifiedName: "aws.OpsworksMysqlLayer", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.OpsworksMysqlLayerConfig\"}}]")]
    public class OpsworksMysqlLayer : HashiCorp.Cdktf.TerraformResource
    {
        public OpsworksMysqlLayer(Constructs.Construct scope, string id, aws.IOpsworksMysqlLayerConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "ebsVolumeInput", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.OpsworksMysqlLayerEbsVolume\"},\"kind\":\"array\"}}", isOptional: true)]
        public virtual aws.IOpsworksMysqlLayerEbsVolume[]? EbsVolumeInput
        {
            get => GetInstanceProperty<aws.IOpsworksMysqlLayerEbsVolume[]?>();
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "rootPasswordOnAllInstancesInput", typeJson: "{\"primitive\":\"boolean\"}", isOptional: true)]
        public virtual bool? RootPasswordOnAllInstancesInput
        {
            get => GetInstanceProperty<bool?>();
        }
        ...
        [JsiiProperty(name: "ebsVolume", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.OpsworksMysqlLayerEbsVolume\"},\"kind\":\"array\"}}")]
        public virtual aws.IOpsworksMysqlLayerEbsVolume[] EbsVolume
        {
            get => GetInstanceProperty<aws.IOpsworksMysqlLayerEbsVolume[]>()!;
            set => SetInstanceProperty(value);
        }
        ...
        [JsiiProperty(name: "rootPasswordOnAllInstances", typeJson: "{\"primitive\":\"boolean\"}")]
        public virtual bool RootPasswordOnAllInstances
        {
            get => GetInstanceProperty<bool>()!;
            set => SetInstanceProperty(value);
        }
