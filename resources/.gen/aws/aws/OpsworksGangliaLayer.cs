...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.OpsworksGangliaLayer), fullyQualifiedName: "aws.OpsworksGangliaLayer", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.OpsworksGangliaLayerConfig\"}}]")]
    public class OpsworksGangliaLayer : HashiCorp.Cdktf.TerraformResource
    {
        public OpsworksGangliaLayer(Constructs.Construct scope, string id, aws.IOpsworksGangliaLayerConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "ebsVolumeInput", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.OpsworksGangliaLayerEbsVolume\"},\"kind\":\"array\"}}", isOptional: true)]
        public virtual aws.IOpsworksGangliaLayerEbsVolume[]? EbsVolumeInput
        {
            get => GetInstanceProperty<aws.IOpsworksGangliaLayerEbsVolume[]?>();
        }
        ...
        [JsiiProperty(name: "ebsVolume", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.OpsworksGangliaLayerEbsVolume\"},\"kind\":\"array\"}}")]
        public virtual aws.IOpsworksGangliaLayerEbsVolume[] EbsVolume
        {
            get => GetInstanceProperty<aws.IOpsworksGangliaLayerEbsVolume[]>()!;
            set => SetInstanceProperty(value);
        }
