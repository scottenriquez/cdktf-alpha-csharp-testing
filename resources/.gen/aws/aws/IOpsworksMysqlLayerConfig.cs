...
namespace aws
{
    [JsiiInterface(nativeType: typeof(IOpsworksMysqlLayerConfig), fullyQualifiedName: "aws.OpsworksMysqlLayerConfig")]
    public interface IOpsworksMysqlLayerConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        [JsiiProperty(name: "ebsVolume", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.OpsworksMysqlLayerEbsVolume\"},\"kind\":\"array\"}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.IOpsworksMysqlLayerEbsVolume[]? EbsVolume
        {
            get
            {
                return null;
        ...
        [JsiiProperty(name: "rootPasswordOnAllInstances", typeJson: "{\"primitive\":\"boolean\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        bool? RootPasswordOnAllInstances
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IOpsworksMysqlLayerConfig), fullyQualifiedName: "aws.OpsworksMysqlLayerConfig")]
        internal sealed class _Proxy : DeputyBase, aws.IOpsworksMysqlLayerConfig
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "ebsVolume", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.OpsworksMysqlLayerEbsVolume\"},\"kind\":\"array\"}}", isOptional: true)]
            public aws.IOpsworksMysqlLayerEbsVolume[]? EbsVolume
            {
