...
namespace aws
{
    [JsiiInterface(nativeType: typeof(IPinpointApnsVoipChannelConfig), fullyQualifiedName: "aws.PinpointApnsVoipChannelConfig")]
    public interface IPinpointApnsVoipChannelConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IPinpointApnsVoipChannelConfig), fullyQualifiedName: "aws.PinpointApnsVoipChannelConfig")]
        internal sealed class _Proxy : DeputyBase, aws.IPinpointApnsVoipChannelConfig
        {
