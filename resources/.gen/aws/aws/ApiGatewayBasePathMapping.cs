...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.ApiGatewayBasePathMapping), fullyQualifiedName: "aws.ApiGatewayBasePathMapping", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.ApiGatewayBasePathMappingConfig\"}}]")]
    public class ApiGatewayBasePathMapping : HashiCorp.Cdktf.TerraformResource
    {
        public ApiGatewayBasePathMapping(Constructs.Construct scope, string id, aws.IApiGatewayBasePathMappingConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
