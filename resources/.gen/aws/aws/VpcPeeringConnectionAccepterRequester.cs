...
namespace aws
{
    [JsiiByValue(fqn: "aws.VpcPeeringConnectionAccepterRequester")]
    public class VpcPeeringConnectionAccepterRequester : aws.IVpcPeeringConnectionAccepterRequester
    {
        [JsiiOptional]
