...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.CognitoIdentityPoolConfig")]
    public class CognitoIdentityPoolConfig : aws.ICognitoIdentityPoolConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "allowUnauthenticatedIdentities", typeJson: "{\"primitive\":\"boolean\"}", isOptional: true, isOverride: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "cognitoIdentityProviders", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.CognitoIdentityPoolCognitoIdentityProviders\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "supportedLoginProviders", typeJson: "{\"collection\":{\"elementtype\":{\"primitive\":\"string\"},\"kind\":\"map\"}}", isOptional: true, isOverride: true)]
