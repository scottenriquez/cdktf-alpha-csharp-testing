...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.InspectorAssessmentTemplate), fullyQualifiedName: "aws.InspectorAssessmentTemplate", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.InspectorAssessmentTemplateConfig\"}}]")]
    public class InspectorAssessmentTemplate : HashiCorp.Cdktf.TerraformResource
    {
        public InspectorAssessmentTemplate(Constructs.Construct scope, string id, aws.IInspectorAssessmentTemplateConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        [JsiiProperty(name: "rulesPackageArnsInput", typeJson: "{\"collection\":{\"elementtype\":{\"primitive\":\"string\"},\"kind\":\"array\"}}")]
        public virtual string[] RulesPackageArnsInput
        {
            get => GetInstanceProperty<string[]>()!;
        }

        [JsiiProperty(name: "targetArnInput", typeJson: "{\"primitive\":\"string\"}")]
