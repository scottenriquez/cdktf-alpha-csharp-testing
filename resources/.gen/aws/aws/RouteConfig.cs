...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.RouteConfig")]
    public class RouteConfig : aws.IRouteConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.RouteTimeouts\"}", isOptional: true, isOverride: true)]
