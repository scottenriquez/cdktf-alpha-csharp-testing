...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.Ec2TransitGatewayRouteTableAssociationConfig")]
    public class Ec2TransitGatewayRouteTableAssociationConfig : aws.IEc2TransitGatewayRouteTableAssociationConfig
    {
