...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.DataAwsSubnet), fullyQualifiedName: "aws.DataAwsSubnet", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"optional\":true,\"type\":{\"fqn\":\"aws.DataAwsSubnetConfig\"}}]")]
    public class DataAwsSubnet : HashiCorp.Cdktf.TerraformDataSource
    {
        ...
        [JsiiProperty(name: "assignIpv6AddressOnCreation", typeJson: "{\"primitive\":\"boolean\"}")]
        public virtual bool AssignIpv6AddressOnCreation
        {
        ...
        [JsiiProperty(name: "mapPublicIpOnLaunch", typeJson: "{\"primitive\":\"boolean\"}")]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "defaultForAzInput", typeJson: "{\"primitive\":\"boolean\"}", isOptional: true)]
        public virtual bool? DefaultForAzInput
        {
            get => GetInstanceProperty<bool?>();
        }

        [JsiiOptional]
        [JsiiProperty(name: "filterInput", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.DataAwsSubnetFilter\"},\"kind\":\"array\"}}", isOptional: true)]
        public virtual aws.IDataAwsSubnetFilter[]? FilterInput
        {
        ...
        [JsiiProperty(name: "defaultForAz", typeJson: "{\"primitive\":\"boolean\"}")]
        public virtual bool DefaultForAz
        {
            get => GetInstanceProperty<bool>()!;
            set => SetInstanceProperty(value);
        }

        [JsiiProperty(name: "filter", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.DataAwsSubnetFilter\"},\"kind\":\"array\"}}")]
        public virtual aws.IDataAwsSubnetFilter[] Filter
        {
            get => GetInstanceProperty<aws.IDataAwsSubnetFilter[]>()!;
            set => SetInstanceProperty(value);
        }
