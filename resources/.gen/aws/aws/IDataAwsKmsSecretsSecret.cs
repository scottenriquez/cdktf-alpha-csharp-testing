...
namespace aws
{
    [JsiiInterface(nativeType: typeof(IDataAwsKmsSecretsSecret), fullyQualifiedName: "aws.DataAwsKmsSecretsSecret")]
    public interface IDataAwsKmsSecretsSecret
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDataAwsKmsSecretsSecret), fullyQualifiedName: "aws.DataAwsKmsSecretsSecret")]
        internal sealed class _Proxy : DeputyBase, aws.IDataAwsKmsSecretsSecret
        {
