...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.DbClusterSnapshotConfig")]
    public class DbClusterSnapshotConfig : aws.IDbClusterSnapshotConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.DbClusterSnapshotTimeouts\"}", isOptional: true, isOverride: true)]
