...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.DataAwsLambdaAlias), fullyQualifiedName: "aws.DataAwsLambdaAlias", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.DataAwsLambdaAliasConfig\"}}]")]
    public class DataAwsLambdaAlias : HashiCorp.Cdktf.TerraformDataSource
    {
        public DataAwsLambdaAlias(Constructs.Construct scope, string id, aws.IDataAwsLambdaAliasConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
