...
namespace aws
{
    [JsiiInterface(nativeType: typeof(IAlbListenerConfig), fullyQualifiedName: "aws.AlbListenerConfig")]
    public interface IAlbListenerConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        aws.IAlbListenerDefaultAction[] DefaultAction
        {
            get;
        }
        ...
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.AlbListenerTimeouts\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.IAlbListenerTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IAlbListenerConfig), fullyQualifiedName: "aws.AlbListenerConfig")]
        internal sealed class _Proxy : DeputyBase, aws.IAlbListenerConfig
        {
            ...
            /// <summary>default_action block.</summary>
            [JsiiProperty(name: "defaultAction", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.AlbListenerDefaultAction\"},\"kind\":\"array\"}}")]
            public aws.IAlbListenerDefaultAction[] DefaultAction
            {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.AlbListenerTimeouts\"}", isOptional: true)]
            public aws.IAlbListenerTimeouts? Timeouts
            {
