...
namespace aws
{
    [JsiiByValue(fqn: "aws.Ec2TrafficMirrorFilterRuleSourcePortRange")]
    public class Ec2TrafficMirrorFilterRuleSourcePortRange : aws.IEc2TrafficMirrorFilterRuleSourcePortRange
    {
        [JsiiOptional]
