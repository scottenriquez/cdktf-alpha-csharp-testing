...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.DxLagConfig")]
    public class DxLagConfig : aws.IDxLagConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "numberOfConnections", typeJson: "{\"primitive\":\"number\"}", isOptional: true, isOverride: true)]
