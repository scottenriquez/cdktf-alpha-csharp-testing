...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.PinpointApnsChannel), fullyQualifiedName: "aws.PinpointApnsChannel", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.PinpointApnsChannelConfig\"}}]")]
    public class PinpointApnsChannel : HashiCorp.Cdktf.TerraformResource
    {
        public PinpointApnsChannel(Constructs.Construct scope, string id, aws.IPinpointApnsChannelConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
