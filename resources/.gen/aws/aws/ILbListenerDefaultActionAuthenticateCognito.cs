...
namespace aws
{
    [JsiiInterface(nativeType: typeof(ILbListenerDefaultActionAuthenticateCognito), fullyQualifiedName: "aws.LbListenerDefaultActionAuthenticateCognito")]
    public interface ILbListenerDefaultActionAuthenticateCognito
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ILbListenerDefaultActionAuthenticateCognito), fullyQualifiedName: "aws.LbListenerDefaultActionAuthenticateCognito")]
        internal sealed class _Proxy : DeputyBase, aws.ILbListenerDefaultActionAuthenticateCognito
        {
