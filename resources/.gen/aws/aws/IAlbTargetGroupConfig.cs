...
namespace aws
{
    [JsiiInterface(nativeType: typeof(IAlbTargetGroupConfig), fullyQualifiedName: "aws.AlbTargetGroupConfig")]
    public interface IAlbTargetGroupConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        [JsiiProperty(name: "healthCheck", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.AlbTargetGroupHealthCheck\"},\"kind\":\"array\"}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.IAlbTargetGroupHealthCheck[]? HealthCheck
        {
            get
            {
                return null;
        ...
        [JsiiProperty(name: "stickiness", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.AlbTargetGroupStickiness\"},\"kind\":\"array\"}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.IAlbTargetGroupStickiness[]? Stickiness
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IAlbTargetGroupConfig), fullyQualifiedName: "aws.AlbTargetGroupConfig")]
        internal sealed class _Proxy : DeputyBase, aws.IAlbTargetGroupConfig
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "healthCheck", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.AlbTargetGroupHealthCheck\"},\"kind\":\"array\"}}", isOptional: true)]
            public aws.IAlbTargetGroupHealthCheck[]? HealthCheck
            {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "stickiness", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.AlbTargetGroupStickiness\"},\"kind\":\"array\"}}", isOptional: true)]
            public aws.IAlbTargetGroupStickiness[]? Stickiness
            {
