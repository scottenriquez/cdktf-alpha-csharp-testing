...
namespace aws
{
    [JsiiByValue(fqn: "aws.SnsSmsPreferencesConfig")]
    public class SnsSmsPreferencesConfig : aws.ISnsSmsPreferencesConfig
    {
        [JsiiOptional]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "monthlySpendLimit", typeJson: "{\"primitive\":\"string\"}", isOptional: true, isOverride: true)]
