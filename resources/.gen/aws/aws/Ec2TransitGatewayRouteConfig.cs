...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.Ec2TransitGatewayRouteConfig")]
    public class Ec2TransitGatewayRouteConfig : aws.IEc2TransitGatewayRouteConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "blackhole", typeJson: "{\"primitive\":\"boolean\"}", isOptional: true, isOverride: true)]
