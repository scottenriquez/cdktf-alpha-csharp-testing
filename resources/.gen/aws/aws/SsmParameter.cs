...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.SsmParameter), fullyQualifiedName: "aws.SsmParameter", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.SsmParameterConfig\"}}]")]
    public class SsmParameter : HashiCorp.Cdktf.TerraformResource
    {
        public SsmParameter(Constructs.Construct scope, string id, aws.ISsmParameterConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        [JsiiProperty(name: "valueInput", typeJson: "{\"primitive\":\"string\"}")]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "overwriteInput", typeJson: "{\"primitive\":\"boolean\"}", isOptional: true)]
        public virtual bool? OverwriteInput
        {
        ...
        [JsiiProperty(name: "overwrite", typeJson: "{\"primitive\":\"boolean\"}")]
