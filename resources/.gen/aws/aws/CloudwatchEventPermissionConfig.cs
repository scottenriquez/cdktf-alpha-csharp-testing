...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.CloudwatchEventPermissionConfig")]
    public class CloudwatchEventPermissionConfig : aws.ICloudwatchEventPermissionConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "condition", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.CloudwatchEventPermissionCondition\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
