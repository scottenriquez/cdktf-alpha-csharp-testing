...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.CodecommitRepository), fullyQualifiedName: "aws.CodecommitRepository", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.CodecommitRepositoryConfig\"}}]")]
    public class CodecommitRepository : HashiCorp.Cdktf.TerraformResource
    {
        public CodecommitRepository(Constructs.Construct scope, string id, aws.ICodecommitRepositoryConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
