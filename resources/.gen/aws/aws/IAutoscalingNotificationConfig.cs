...
namespace aws
{
    [JsiiInterface(nativeType: typeof(IAutoscalingNotificationConfig), fullyQualifiedName: "aws.AutoscalingNotificationConfig")]
    public interface IAutoscalingNotificationConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IAutoscalingNotificationConfig), fullyQualifiedName: "aws.AutoscalingNotificationConfig")]
        internal sealed class _Proxy : DeputyBase, aws.IAutoscalingNotificationConfig
        {
