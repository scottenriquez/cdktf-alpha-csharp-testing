...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.DefaultSubnet), fullyQualifiedName: "aws.DefaultSubnet", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.DefaultSubnetConfig\"}}]")]
    public class DefaultSubnet : HashiCorp.Cdktf.TerraformResource
    {
        public DefaultSubnet(Constructs.Construct scope, string id, aws.IDefaultSubnetConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "timeoutsInput", typeJson: "{\"fqn\":\"aws.DefaultSubnetTimeouts\"}", isOptional: true)]
        public virtual aws.IDefaultSubnetTimeouts? TimeoutsInput
        {
        ...
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.DefaultSubnetTimeouts\"}")]
        public virtual aws.IDefaultSubnetTimeouts Timeouts
        {
            get => GetInstanceProperty<aws.IDefaultSubnetTimeouts>()!;
            set => SetInstanceProperty(value);
        }
