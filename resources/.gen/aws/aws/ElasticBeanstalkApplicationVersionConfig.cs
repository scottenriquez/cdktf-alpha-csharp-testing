...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.ElasticBeanstalkApplicationVersionConfig")]
    public class ElasticBeanstalkApplicationVersionConfig : aws.IElasticBeanstalkApplicationVersionConfig
    {
