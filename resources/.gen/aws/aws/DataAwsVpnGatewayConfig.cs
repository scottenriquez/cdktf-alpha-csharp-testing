...
namespace aws
{
    [JsiiByValue(fqn: "aws.DataAwsVpnGatewayConfig")]
    public class DataAwsVpnGatewayConfig : aws.IDataAwsVpnGatewayConfig
    {
        [JsiiOptional]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "filter", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.DataAwsVpnGatewayFilter\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
