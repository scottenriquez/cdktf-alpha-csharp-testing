...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.AlbListenerDefaultActionAuthenticateOidc")]
    public class AlbListenerDefaultActionAuthenticateOidc : aws.IAlbListenerDefaultActionAuthenticateOidc
    {
