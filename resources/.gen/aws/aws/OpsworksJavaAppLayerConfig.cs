...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.OpsworksJavaAppLayerConfig")]
    public class OpsworksJavaAppLayerConfig : aws.IOpsworksJavaAppLayerConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "ebsVolume", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.OpsworksJavaAppLayerEbsVolume\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
