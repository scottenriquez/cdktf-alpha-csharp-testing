...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.LoadBalancerListenerPolicy), fullyQualifiedName: "aws.LoadBalancerListenerPolicy", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.LoadBalancerListenerPolicyConfig\"}}]")]
    public class LoadBalancerListenerPolicy : HashiCorp.Cdktf.TerraformResource
    {
        public LoadBalancerListenerPolicy(Constructs.Construct scope, string id, aws.ILoadBalancerListenerPolicyConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        [JsiiProperty(name: "loadBalancerPortInput", typeJson: "{\"primitive\":\"number\"}")]
