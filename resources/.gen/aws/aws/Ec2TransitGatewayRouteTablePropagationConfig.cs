...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.Ec2TransitGatewayRouteTablePropagationConfig")]
    public class Ec2TransitGatewayRouteTablePropagationConfig : aws.IEc2TransitGatewayRouteTablePropagationConfig
    {
