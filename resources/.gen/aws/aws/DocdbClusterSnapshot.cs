...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.DocdbClusterSnapshot), fullyQualifiedName: "aws.DocdbClusterSnapshot", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.DocdbClusterSnapshotConfig\"}}]")]
    public class DocdbClusterSnapshot : HashiCorp.Cdktf.TerraformResource
    {
        public DocdbClusterSnapshot(Constructs.Construct scope, string id, aws.IDocdbClusterSnapshotConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "timeoutsInput", typeJson: "{\"fqn\":\"aws.DocdbClusterSnapshotTimeouts\"}", isOptional: true)]
        public virtual aws.IDocdbClusterSnapshotTimeouts? TimeoutsInput
        {
        ...
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.DocdbClusterSnapshotTimeouts\"}")]
        public virtual aws.IDocdbClusterSnapshotTimeouts Timeouts
        {
            get => GetInstanceProperty<aws.IDocdbClusterSnapshotTimeouts>()!;
            set => SetInstanceProperty(value);
        }
