...
namespace aws
{
    [JsiiInterface(nativeType: typeof(ICloudfrontDistributionDefaultCacheBehavior), fullyQualifiedName: "aws.CloudfrontDistributionDefaultCacheBehavior")]
    public interface ICloudfrontDistributionDefaultCacheBehavior
    {
        ...
        [JsiiProperty(name: "forwardedValues", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.CloudfrontDistributionDefaultCacheBehaviorForwardedValues\"},\"kind\":\"array\"}}")]
        aws.ICloudfrontDistributionDefaultCacheBehaviorForwardedValues[] ForwardedValues
        {
            get;
        }
        ...
        [JsiiProperty(name: "lambdaFunctionAssociation", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.CloudfrontDistributionDefaultCacheBehaviorLambdaFunctionAssociation\"},\"kind\":\"array\"}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.ICloudfrontDistributionDefaultCacheBehaviorLambdaFunctionAssociation[]? LambdaFunctionAssociation
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(ICloudfrontDistributionDefaultCacheBehavior), fullyQualifiedName: "aws.CloudfrontDistributionDefaultCacheBehavior")]
        internal sealed class _Proxy : DeputyBase, aws.ICloudfrontDistributionDefaultCacheBehavior
        {
            ...
            {
                get => GetInstanceProperty<aws.ICloudfrontDistributionDefaultCacheBehaviorForwardedValues[]>()!;
            }
            ...
            {
                get => GetInstanceProperty<aws.ICloudfrontDistributionDefaultCacheBehaviorLambdaFunctionAssociation[]?>();
            }
