...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.OpsworksRailsAppLayerConfig")]
    public class OpsworksRailsAppLayerConfig : aws.IOpsworksRailsAppLayerConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "ebsVolume", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.OpsworksRailsAppLayerEbsVolume\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "manageBundler", typeJson: "{\"primitive\":\"boolean\"}", isOptional: true, isOverride: true)]
