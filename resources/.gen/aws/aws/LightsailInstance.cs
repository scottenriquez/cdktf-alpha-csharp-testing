...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.LightsailInstance), fullyQualifiedName: "aws.LightsailInstance", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.LightsailInstanceConfig\"}}]")]
    public class LightsailInstance : HashiCorp.Cdktf.TerraformResource
    {
        ...
        [JsiiProperty(name: "blueprintIdInput", typeJson: "{\"primitive\":\"string\"}")]
        ...
        [JsiiProperty(name: "isStaticIp", typeJson: "{\"primitive\":\"boolean\"}")]
        public virtual bool IsStaticIp
        {
