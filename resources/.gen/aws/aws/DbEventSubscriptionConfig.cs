...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.DbEventSubscriptionConfig")]
    public class DbEventSubscriptionConfig : aws.IDbEventSubscriptionConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.DbEventSubscriptionTimeouts\"}", isOptional: true, isOverride: true)]
        public aws.IDbEventSubscriptionTimeouts? Timeouts
        {
            get;
            set;
        }
