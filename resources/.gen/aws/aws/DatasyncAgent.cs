...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.DatasyncAgent), fullyQualifiedName: "aws.DatasyncAgent", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"optional\":true,\"type\":{\"fqn\":\"aws.DatasyncAgentConfig\"}}]")]
    public class DatasyncAgent : HashiCorp.Cdktf.TerraformResource
    {
        public DatasyncAgent(Constructs.Construct scope, string id, aws.IDatasyncAgentConfig? config = null): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "timeoutsInput", typeJson: "{\"fqn\":\"aws.DatasyncAgentTimeouts\"}", isOptional: true)]
        public virtual aws.IDatasyncAgentTimeouts? TimeoutsInput
        {
        ...
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.DatasyncAgentTimeouts\"}")]
        public virtual aws.IDatasyncAgentTimeouts Timeouts
        {
            get => GetInstanceProperty<aws.IDatasyncAgentTimeouts>()!;
            set => SetInstanceProperty(value);
        }
