...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.Ec2ClientVpnNetworkAssociation), fullyQualifiedName: "aws.Ec2ClientVpnNetworkAssociation", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.Ec2ClientVpnNetworkAssociationConfig\"}}]")]
    public class Ec2ClientVpnNetworkAssociation : HashiCorp.Cdktf.TerraformResource
    {
        public Ec2ClientVpnNetworkAssociation(Constructs.Construct scope, string id, aws.IEc2ClientVpnNetworkAssociationConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
