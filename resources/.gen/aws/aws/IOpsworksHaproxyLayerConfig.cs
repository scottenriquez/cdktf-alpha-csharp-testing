...
namespace aws
{
    [JsiiInterface(nativeType: typeof(IOpsworksHaproxyLayerConfig), fullyQualifiedName: "aws.OpsworksHaproxyLayerConfig")]
    public interface IOpsworksHaproxyLayerConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        [JsiiProperty(name: "ebsVolume", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.OpsworksHaproxyLayerEbsVolume\"},\"kind\":\"array\"}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.IOpsworksHaproxyLayerEbsVolume[]? EbsVolume
        {
            get
            {
                return null;
        ...
        [JsiiProperty(name: "statsEnabled", typeJson: "{\"primitive\":\"boolean\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        bool? StatsEnabled
        {
            get
        ...
        [JsiiTypeProxy(nativeType: typeof(IOpsworksHaproxyLayerConfig), fullyQualifiedName: "aws.OpsworksHaproxyLayerConfig")]
        internal sealed class _Proxy : DeputyBase, aws.IOpsworksHaproxyLayerConfig
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "ebsVolume", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.OpsworksHaproxyLayerEbsVolume\"},\"kind\":\"array\"}}", isOptional: true)]
            public aws.IOpsworksHaproxyLayerEbsVolume[]? EbsVolume
            {
