...
namespace aws
{
    ...
    public interface IEmrClusterMasterInstanceGroupEbsConfig
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IEmrClusterMasterInstanceGroupEbsConfig), fullyQualifiedName: "aws.EmrClusterMasterInstanceGroupEbsConfig")]
        internal sealed class _Proxy : DeputyBase, aws.IEmrClusterMasterInstanceGroupEbsConfig
        {
