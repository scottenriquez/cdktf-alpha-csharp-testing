...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.AlbListenerDefaultActionAuthenticateCognito")]
    public class AlbListenerDefaultActionAuthenticateCognito : aws.IAlbListenerDefaultActionAuthenticateCognito
    {
