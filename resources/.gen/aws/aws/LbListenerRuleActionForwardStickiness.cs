...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.LbListenerRuleActionForwardStickiness")]
    public class LbListenerRuleActionForwardStickiness : aws.ILbListenerRuleActionForwardStickiness
    {
