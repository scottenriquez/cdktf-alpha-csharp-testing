...
namespace aws
{
    [JsiiInterface(nativeType: typeof(ISagemakerModelContainer), fullyQualifiedName: "aws.SagemakerModelContainer")]
    public interface ISagemakerModelContainer
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ISagemakerModelContainer), fullyQualifiedName: "aws.SagemakerModelContainer")]
        internal sealed class _Proxy : DeputyBase, aws.ISagemakerModelContainer
        {
