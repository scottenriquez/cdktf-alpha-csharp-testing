...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.DxBgpPeerConfig")]
    public class DxBgpPeerConfig : aws.IDxBgpPeerConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.DxBgpPeerTimeouts\"}", isOptional: true, isOverride: true)]
