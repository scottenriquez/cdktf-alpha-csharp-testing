...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.LoadBalancerBackendServerPolicyConfig")]
    public class LoadBalancerBackendServerPolicyConfig : aws.ILoadBalancerBackendServerPolicyConfig
    {
