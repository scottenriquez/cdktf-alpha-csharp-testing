...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.DxHostedTransitVirtualInterfaceConfig")]
    public class DxHostedTransitVirtualInterfaceConfig : aws.IDxHostedTransitVirtualInterfaceConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.DxHostedTransitVirtualInterfaceTimeouts\"}", isOptional: true, isOverride: true)]
