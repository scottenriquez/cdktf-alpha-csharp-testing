...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.OpsworksJavaAppLayer), fullyQualifiedName: "aws.OpsworksJavaAppLayer", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.OpsworksJavaAppLayerConfig\"}}]")]
    public class OpsworksJavaAppLayer : HashiCorp.Cdktf.TerraformResource
    {
        public OpsworksJavaAppLayer(Constructs.Construct scope, string id, aws.IOpsworksJavaAppLayerConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "ebsVolumeInput", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.OpsworksJavaAppLayerEbsVolume\"},\"kind\":\"array\"}}", isOptional: true)]
        public virtual aws.IOpsworksJavaAppLayerEbsVolume[]? EbsVolumeInput
        {
        ...
        [JsiiProperty(name: "ebsVolume", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.OpsworksJavaAppLayerEbsVolume\"},\"kind\":\"array\"}}")]
        public virtual aws.IOpsworksJavaAppLayerEbsVolume[] EbsVolume
        {
            get => GetInstanceProperty<aws.IOpsworksJavaAppLayerEbsVolume[]>()!;
            set => SetInstanceProperty(value);
        }
