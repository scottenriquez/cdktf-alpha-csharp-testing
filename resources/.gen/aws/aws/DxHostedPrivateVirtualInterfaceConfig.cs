...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.DxHostedPrivateVirtualInterfaceConfig")]
    public class DxHostedPrivateVirtualInterfaceConfig : aws.IDxHostedPrivateVirtualInterfaceConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.DxHostedPrivateVirtualInterfaceTimeouts\"}", isOptional: true, isOverride: true)]
