...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.NeptuneEventSubscription), fullyQualifiedName: "aws.NeptuneEventSubscription", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.NeptuneEventSubscriptionConfig\"}}]")]
    public class NeptuneEventSubscription : HashiCorp.Cdktf.TerraformResource
    {
        public NeptuneEventSubscription(Constructs.Construct scope, string id, aws.INeptuneEventSubscriptionConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "timeoutsInput", typeJson: "{\"fqn\":\"aws.NeptuneEventSubscriptionTimeouts\"}", isOptional: true)]
        public virtual aws.INeptuneEventSubscriptionTimeouts? TimeoutsInput
        {
            get => GetInstanceProperty<aws.INeptuneEventSubscriptionTimeouts?>();
        }
        ...
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.NeptuneEventSubscriptionTimeouts\"}")]
        public virtual aws.INeptuneEventSubscriptionTimeouts Timeouts
        {
            get => GetInstanceProperty<aws.INeptuneEventSubscriptionTimeouts>()!;
            set => SetInstanceProperty(value);
        }
