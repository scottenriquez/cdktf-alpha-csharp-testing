...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.WafregionalRateBasedRuleConfig")]
    public class WafregionalRateBasedRuleConfig : aws.IWafregionalRateBasedRuleConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "predicate", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.WafregionalRateBasedRulePredicate\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
