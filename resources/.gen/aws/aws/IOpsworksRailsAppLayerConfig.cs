...
namespace aws
{
    [JsiiInterface(nativeType: typeof(IOpsworksRailsAppLayerConfig), fullyQualifiedName: "aws.OpsworksRailsAppLayerConfig")]
    public interface IOpsworksRailsAppLayerConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        [JsiiProperty(name: "ebsVolume", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.OpsworksRailsAppLayerEbsVolume\"},\"kind\":\"array\"}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.IOpsworksRailsAppLayerEbsVolume[]? EbsVolume
        {
            get
            {
                return null;
        ...
        [JsiiProperty(name: "manageBundler", typeJson: "{\"primitive\":\"boolean\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        bool? ManageBundler
        {
            get
        ...
        [JsiiTypeProxy(nativeType: typeof(IOpsworksRailsAppLayerConfig), fullyQualifiedName: "aws.OpsworksRailsAppLayerConfig")]
        internal sealed class _Proxy : DeputyBase, aws.IOpsworksRailsAppLayerConfig
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "ebsVolume", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.OpsworksRailsAppLayerEbsVolume\"},\"kind\":\"array\"}}", isOptional: true)]
            public aws.IOpsworksRailsAppLayerEbsVolume[]? EbsVolume
            {
