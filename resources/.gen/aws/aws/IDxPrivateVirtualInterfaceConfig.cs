...
namespace aws
{
    [JsiiInterface(nativeType: typeof(IDxPrivateVirtualInterfaceConfig), fullyQualifiedName: "aws.DxPrivateVirtualInterfaceConfig")]
    public interface IDxPrivateVirtualInterfaceConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.DxPrivateVirtualInterfaceTimeouts\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.IDxPrivateVirtualInterfaceTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDxPrivateVirtualInterfaceConfig), fullyQualifiedName: "aws.DxPrivateVirtualInterfaceConfig")]
        internal sealed class _Proxy : DeputyBase, aws.IDxPrivateVirtualInterfaceConfig
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.DxPrivateVirtualInterfaceTimeouts\"}", isOptional: true)]
            public aws.IDxPrivateVirtualInterfaceTimeouts? Timeouts
            {
