...
namespace aws
{
    [JsiiInterface(nativeType: typeof(IPinpointApnsVoipSandboxChannelConfig), fullyQualifiedName: "aws.PinpointApnsVoipSandboxChannelConfig")]
    public interface IPinpointApnsVoipSandboxChannelConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IPinpointApnsVoipSandboxChannelConfig), fullyQualifiedName: "aws.PinpointApnsVoipSandboxChannelConfig")]
        internal sealed class _Proxy : DeputyBase, aws.IPinpointApnsVoipSandboxChannelConfig
        {
