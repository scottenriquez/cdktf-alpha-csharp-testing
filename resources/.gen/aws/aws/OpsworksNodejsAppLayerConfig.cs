...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.OpsworksNodejsAppLayerConfig")]
    public class OpsworksNodejsAppLayerConfig : aws.IOpsworksNodejsAppLayerConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "ebsVolume", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.OpsworksNodejsAppLayerEbsVolume\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
