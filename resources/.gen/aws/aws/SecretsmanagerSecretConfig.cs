...
namespace aws
{
    [JsiiByValue(fqn: "aws.SecretsmanagerSecretConfig")]
    public class SecretsmanagerSecretConfig : aws.ISecretsmanagerSecretConfig
    {
        [JsiiOptional]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "rotationRules", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.SecretsmanagerSecretRotationRules\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
