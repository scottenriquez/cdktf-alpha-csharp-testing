...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.LbListenerDefaultActionAuthenticateCognito")]
    public class LbListenerDefaultActionAuthenticateCognito : aws.ILbListenerDefaultActionAuthenticateCognito
    {
