...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.SsmMaintenanceWindowConfig")]
    public class SsmMaintenanceWindowConfig : aws.ISsmMaintenanceWindowConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "allowUnassociatedTargets", typeJson: "{\"primitive\":\"boolean\"}", isOptional: true, isOverride: true)]
