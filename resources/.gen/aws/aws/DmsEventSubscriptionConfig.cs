...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.DmsEventSubscriptionConfig")]
    public class DmsEventSubscriptionConfig : aws.IDmsEventSubscriptionConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.DmsEventSubscriptionTimeouts\"}", isOptional: true, isOverride: true)]
