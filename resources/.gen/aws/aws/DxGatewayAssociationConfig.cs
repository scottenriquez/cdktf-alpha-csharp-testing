...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.DxGatewayAssociationConfig")]
    public class DxGatewayAssociationConfig : aws.IDxGatewayAssociationConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.DxGatewayAssociationTimeouts\"}", isOptional: true, isOverride: true)]
