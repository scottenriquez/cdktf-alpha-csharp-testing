...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.DataAwsS3BucketObjectsConfig")]
    public class DataAwsS3BucketObjectsConfig : aws.IDataAwsS3BucketObjectsConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "fetchOwner", typeJson: "{\"primitive\":\"boolean\"}", isOptional: true, isOverride: true)]
