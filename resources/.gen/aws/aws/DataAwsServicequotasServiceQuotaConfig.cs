...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.DataAwsServicequotasServiceQuotaConfig")]
    public class DataAwsServicequotasServiceQuotaConfig : aws.IDataAwsServicequotasServiceQuotaConfig
    {
