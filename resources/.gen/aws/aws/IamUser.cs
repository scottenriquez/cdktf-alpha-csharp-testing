...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.IamUser), fullyQualifiedName: "aws.IamUser", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.IamUserConfig\"}}]")]
    public class IamUser : HashiCorp.Cdktf.TerraformResource
    {
        public IamUser(Constructs.Construct scope, string id, aws.IIamUserConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
