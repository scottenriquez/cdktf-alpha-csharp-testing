...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.LicensemanagerLicenseConfigurationConfig")]
    public class LicensemanagerLicenseConfigurationConfig : aws.ILicensemanagerLicenseConfigurationConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "licenseCountHardLimit", typeJson: "{\"primitive\":\"boolean\"}", isOptional: true, isOverride: true)]
