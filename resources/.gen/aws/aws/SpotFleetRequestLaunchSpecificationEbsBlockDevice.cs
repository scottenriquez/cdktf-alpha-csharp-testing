...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.SpotFleetRequestLaunchSpecificationEbsBlockDevice")]
    public class SpotFleetRequestLaunchSpecificationEbsBlockDevice : aws.ISpotFleetRequestLaunchSpecificationEbsBlockDevice
    {
