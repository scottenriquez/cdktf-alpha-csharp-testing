...
namespace aws
{
    [JsiiInterface(nativeType: typeof(IOpsworksStaticWebLayerConfig), fullyQualifiedName: "aws.OpsworksStaticWebLayerConfig")]
    public interface IOpsworksStaticWebLayerConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        [JsiiProperty(name: "ebsVolume", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.OpsworksStaticWebLayerEbsVolume\"},\"kind\":\"array\"}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.IOpsworksStaticWebLayerEbsVolume[]? EbsVolume
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IOpsworksStaticWebLayerConfig), fullyQualifiedName: "aws.OpsworksStaticWebLayerConfig")]
        internal sealed class _Proxy : DeputyBase, aws.IOpsworksStaticWebLayerConfig
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "ebsVolume", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.OpsworksStaticWebLayerEbsVolume\"},\"kind\":\"array\"}}", isOptional: true)]
            public aws.IOpsworksStaticWebLayerEbsVolume[]? EbsVolume
            {
