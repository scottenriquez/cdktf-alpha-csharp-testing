...
namespace aws
{
    [JsiiInterface(nativeType: typeof(ILicensemanagerLicenseConfigurationConfig), fullyQualifiedName: "aws.LicensemanagerLicenseConfigurationConfig")]
    public interface ILicensemanagerLicenseConfigurationConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        [JsiiProperty(name: "licenseCountHardLimit", typeJson: "{\"primitive\":\"boolean\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        ...
        [JsiiTypeProxy(nativeType: typeof(ILicensemanagerLicenseConfigurationConfig), fullyQualifiedName: "aws.LicensemanagerLicenseConfigurationConfig")]
        internal sealed class _Proxy : DeputyBase, aws.ILicensemanagerLicenseConfigurationConfig
        {
