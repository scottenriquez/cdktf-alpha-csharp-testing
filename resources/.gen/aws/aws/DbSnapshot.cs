...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.DbSnapshot), fullyQualifiedName: "aws.DbSnapshot", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.DbSnapshotConfig\"}}]")]
    public class DbSnapshot : HashiCorp.Cdktf.TerraformResource
    {
        public DbSnapshot(Constructs.Construct scope, string id, aws.IDbSnapshotConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        [JsiiProperty(name: "dbSnapshotIdentifierInput", typeJson: "{\"primitive\":\"string\"}")]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "timeoutsInput", typeJson: "{\"fqn\":\"aws.DbSnapshotTimeouts\"}", isOptional: true)]
        public virtual aws.IDbSnapshotTimeouts? TimeoutsInput
        {
        ...
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.DbSnapshotTimeouts\"}")]
        public virtual aws.IDbSnapshotTimeouts Timeouts
        {
            get => GetInstanceProperty<aws.IDbSnapshotTimeouts>()!;
            set => SetInstanceProperty(value);
        }
