...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.IamRole), fullyQualifiedName: "aws.IamRole", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.IamRoleConfig\"}}]")]
    public class IamRole : HashiCorp.Cdktf.TerraformResource
    {
        public IamRole(Constructs.Construct scope, string id, aws.IIamRoleConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        [JsiiProperty(name: "assumeRolePolicyInput", typeJson: "{\"primitive\":\"string\"}")]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "forceDetachPoliciesInput", typeJson: "{\"primitive\":\"boolean\"}", isOptional: true)]
        public virtual bool? ForceDetachPoliciesInput
        {
        ...
        [JsiiProperty(name: "forceDetachPolicies", typeJson: "{\"primitive\":\"boolean\"}")]
        public virtual bool ForceDetachPolicies
        {
            get => GetInstanceProperty<bool>()!;
            set => SetInstanceProperty(value);
        }
