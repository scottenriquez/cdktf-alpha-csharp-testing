...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.ConfigOrganizationManagedRuleConfig")]
    public class ConfigOrganizationManagedRuleConfig : aws.IConfigOrganizationManagedRuleConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.ConfigOrganizationManagedRuleTimeouts\"}", isOptional: true, isOverride: true)]
