...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.Wafv2WebAclLoggingConfigurationConfig")]
    public class Wafv2WebAclLoggingConfigurationConfig : aws.IWafv2WebAclLoggingConfigurationConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "redactedFields", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.Wafv2WebAclLoggingConfigurationRedactedFields\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
