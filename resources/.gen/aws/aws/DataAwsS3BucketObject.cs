...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.DataAwsS3BucketObject), fullyQualifiedName: "aws.DataAwsS3BucketObject", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.DataAwsS3BucketObjectConfig\"}}]")]
    public class DataAwsS3BucketObject : HashiCorp.Cdktf.TerraformDataSource
    {
        public DataAwsS3BucketObject(Constructs.Construct scope, string id, aws.IDataAwsS3BucketObjectConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
