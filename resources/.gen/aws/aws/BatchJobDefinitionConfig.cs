...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.BatchJobDefinitionConfig")]
    public class BatchJobDefinitionConfig : aws.IBatchJobDefinitionConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "retryStrategy", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.BatchJobDefinitionRetryStrategy\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "timeout", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.BatchJobDefinitionTimeout\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
