...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.GlueCatalogDatabase), fullyQualifiedName: "aws.GlueCatalogDatabase", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.GlueCatalogDatabaseConfig\"}}]")]
    public class GlueCatalogDatabase : HashiCorp.Cdktf.TerraformResource
    {
        public GlueCatalogDatabase(Constructs.Construct scope, string id, aws.IGlueCatalogDatabaseConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
