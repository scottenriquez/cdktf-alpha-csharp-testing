...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.WorkspacesDirectoryConfig")]
    public class WorkspacesDirectoryConfig : aws.IWorkspacesDirectoryConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "selfServicePermissions", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.WorkspacesDirectorySelfServicePermissions\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
