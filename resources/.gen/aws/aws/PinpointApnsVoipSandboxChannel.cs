...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.PinpointApnsVoipSandboxChannel), fullyQualifiedName: "aws.PinpointApnsVoipSandboxChannel", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.PinpointApnsVoipSandboxChannelConfig\"}}]")]
    public class PinpointApnsVoipSandboxChannel : HashiCorp.Cdktf.TerraformResource
    {
        public PinpointApnsVoipSandboxChannel(Constructs.Construct scope, string id, aws.IPinpointApnsVoipSandboxChannelConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
