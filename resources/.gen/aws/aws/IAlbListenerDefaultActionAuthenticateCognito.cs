...
namespace aws
{
    [JsiiInterface(nativeType: typeof(IAlbListenerDefaultActionAuthenticateCognito), fullyQualifiedName: "aws.AlbListenerDefaultActionAuthenticateCognito")]
    public interface IAlbListenerDefaultActionAuthenticateCognito
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IAlbListenerDefaultActionAuthenticateCognito), fullyQualifiedName: "aws.AlbListenerDefaultActionAuthenticateCognito")]
        internal sealed class _Proxy : DeputyBase, aws.IAlbListenerDefaultActionAuthenticateCognito
        {
