...
namespace aws
{
    [JsiiInterface(nativeType: typeof(IAppsyncFunctionConfig), fullyQualifiedName: "aws.AppsyncFunctionConfig")]
    public interface IAppsyncFunctionConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IAppsyncFunctionConfig), fullyQualifiedName: "aws.AppsyncFunctionConfig")]
        internal sealed class _Proxy : DeputyBase, aws.IAppsyncFunctionConfig
        {
