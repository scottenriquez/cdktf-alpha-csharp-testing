...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.IotTopicRuleErrorActionCloudwatchMetric")]
    public class IotTopicRuleErrorActionCloudwatchMetric : aws.IIotTopicRuleErrorActionCloudwatchMetric
    {
