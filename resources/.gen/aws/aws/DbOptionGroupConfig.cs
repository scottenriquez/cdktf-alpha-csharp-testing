...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.DbOptionGroupConfig")]
    public class DbOptionGroupConfig : aws.IDbOptionGroupConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "option", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.DbOptionGroupOption\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.DbOptionGroupTimeouts\"}", isOptional: true, isOverride: true)]
