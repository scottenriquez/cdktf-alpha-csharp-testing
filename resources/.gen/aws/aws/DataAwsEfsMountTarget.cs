...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.DataAwsEfsMountTarget), fullyQualifiedName: "aws.DataAwsEfsMountTarget", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.DataAwsEfsMountTargetConfig\"}}]")]
    public class DataAwsEfsMountTarget : HashiCorp.Cdktf.TerraformDataSource
    {
        public DataAwsEfsMountTarget(Constructs.Construct scope, string id, aws.IDataAwsEfsMountTargetConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        [JsiiProperty(name: "mountTargetIdInput", typeJson: "{\"primitive\":\"string\"}")]
