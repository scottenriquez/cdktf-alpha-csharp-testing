...
namespace aws
{
    [JsiiByValue(fqn: "aws.AlbConfig")]
    public class AlbConfig : aws.IAlbConfig
    {
        /// <summary>access_logs block.</summary>
        [JsiiOptional]
        [JsiiProperty(name: "accessLogs", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.AlbAccessLogs\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "subnetMapping", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.AlbSubnetMapping\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.AlbTimeouts\"}", isOptional: true, isOverride: true)]
