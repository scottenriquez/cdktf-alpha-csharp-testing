...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.VpcEndpointServiceAllowedPrincipalConfig")]
    public class VpcEndpointServiceAllowedPrincipalConfig : aws.IVpcEndpointServiceAllowedPrincipalConfig
    {
