...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.OpsworksStaticWebLayer), fullyQualifiedName: "aws.OpsworksStaticWebLayer", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.OpsworksStaticWebLayerConfig\"}}]")]
    public class OpsworksStaticWebLayer : HashiCorp.Cdktf.TerraformResource
    {
        public OpsworksStaticWebLayer(Constructs.Construct scope, string id, aws.IOpsworksStaticWebLayerConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "ebsVolumeInput", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.OpsworksStaticWebLayerEbsVolume\"},\"kind\":\"array\"}}", isOptional: true)]
        public virtual aws.IOpsworksStaticWebLayerEbsVolume[]? EbsVolumeInput
        {
            get => GetInstanceProperty<aws.IOpsworksStaticWebLayerEbsVolume[]?>();
        }
        ...
        [JsiiProperty(name: "ebsVolume", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.OpsworksStaticWebLayerEbsVolume\"},\"kind\":\"array\"}}")]
        public virtual aws.IOpsworksStaticWebLayerEbsVolume[] EbsVolume
        {
            get => GetInstanceProperty<aws.IOpsworksStaticWebLayerEbsVolume[]>()!;
            set => SetInstanceProperty(value);
        }
