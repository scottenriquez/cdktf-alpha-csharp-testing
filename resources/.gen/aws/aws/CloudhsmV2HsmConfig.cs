...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.CloudhsmV2HsmConfig")]
    public class CloudhsmV2HsmConfig : aws.ICloudhsmV2HsmConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.CloudhsmV2HsmTimeouts\"}", isOptional: true, isOverride: true)]
        public aws.ICloudhsmV2HsmTimeouts? Timeouts
        {
            get;
            set;
        }
