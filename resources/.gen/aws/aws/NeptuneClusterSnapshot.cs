...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.NeptuneClusterSnapshot), fullyQualifiedName: "aws.NeptuneClusterSnapshot", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.NeptuneClusterSnapshotConfig\"}}]")]
    public class NeptuneClusterSnapshot : HashiCorp.Cdktf.TerraformResource
    {
        public NeptuneClusterSnapshot(Constructs.Construct scope, string id, aws.INeptuneClusterSnapshotConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        [JsiiProperty(name: "dbClusterIdentifierInput", typeJson: "{\"primitive\":\"string\"}")]
        ...
        [JsiiProperty(name: "dbClusterSnapshotIdentifierInput", typeJson: "{\"primitive\":\"string\"}")]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "timeoutsInput", typeJson: "{\"fqn\":\"aws.NeptuneClusterSnapshotTimeouts\"}", isOptional: true)]
        public virtual aws.INeptuneClusterSnapshotTimeouts? TimeoutsInput
        {
        ...
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.NeptuneClusterSnapshotTimeouts\"}")]
        public virtual aws.INeptuneClusterSnapshotTimeouts Timeouts
        {
            get => GetInstanceProperty<aws.INeptuneClusterSnapshotTimeouts>()!;
            set => SetInstanceProperty(value);
        }
