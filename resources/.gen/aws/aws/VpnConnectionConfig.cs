...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.VpnConnectionConfig")]
    public class VpnConnectionConfig : aws.IVpnConnectionConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "staticRoutesOnly", typeJson: "{\"primitive\":\"boolean\"}", isOptional: true, isOverride: true)]
