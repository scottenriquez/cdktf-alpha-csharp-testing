...
namespace aws
{
    [JsiiInterface(nativeType: typeof(IOpsworksPhpAppLayerConfig), fullyQualifiedName: "aws.OpsworksPhpAppLayerConfig")]
    public interface IOpsworksPhpAppLayerConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        [JsiiProperty(name: "ebsVolume", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.OpsworksPhpAppLayerEbsVolume\"},\"kind\":\"array\"}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.IOpsworksPhpAppLayerEbsVolume[]? EbsVolume
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IOpsworksPhpAppLayerConfig), fullyQualifiedName: "aws.OpsworksPhpAppLayerConfig")]
        internal sealed class _Proxy : DeputyBase, aws.IOpsworksPhpAppLayerConfig
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "ebsVolume", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.OpsworksPhpAppLayerEbsVolume\"},\"kind\":\"array\"}}", isOptional: true)]
            public aws.IOpsworksPhpAppLayerEbsVolume[]? EbsVolume
            {
