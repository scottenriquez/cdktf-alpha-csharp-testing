...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.SsmDocumentConfig")]
    public class SsmDocumentConfig : aws.ISsmDocumentConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "attachmentsSource", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.SsmDocumentAttachmentsSource\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "permissions", typeJson: "{\"collection\":{\"elementtype\":{\"primitive\":\"string\"},\"kind\":\"map\"}}", isOptional: true, isOverride: true)]
