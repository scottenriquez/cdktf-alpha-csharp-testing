...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.SsmPatchBaselineApprovalRulePatchFilter")]
    public class SsmPatchBaselineApprovalRulePatchFilter : aws.ISsmPatchBaselineApprovalRulePatchFilter
    {
