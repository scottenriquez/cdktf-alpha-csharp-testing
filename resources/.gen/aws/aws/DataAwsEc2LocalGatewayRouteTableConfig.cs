...
namespace aws
{
    [JsiiByValue(fqn: "aws.DataAwsEc2LocalGatewayRouteTableConfig")]
    public class DataAwsEc2LocalGatewayRouteTableConfig : aws.IDataAwsEc2LocalGatewayRouteTableConfig
    {
        /// <summary>filter block.</summary>
        [JsiiOptional]
        [JsiiProperty(name: "filter", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.DataAwsEc2LocalGatewayRouteTableFilter\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
