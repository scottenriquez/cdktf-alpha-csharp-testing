...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.AlbListenerCertificate), fullyQualifiedName: "aws.AlbListenerCertificate", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.AlbListenerCertificateConfig\"}}]")]
    public class AlbListenerCertificate : HashiCorp.Cdktf.TerraformResource
    {
        public AlbListenerCertificate(Constructs.Construct scope, string id, aws.IAlbListenerCertificateConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
