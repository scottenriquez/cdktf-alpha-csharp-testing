...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.Apigatewayv2AuthorizerConfig")]
    public class Apigatewayv2AuthorizerConfig : aws.IApigatewayv2AuthorizerConfig
    {
        ...
        [JsiiProperty(name: "identitySources", typeJson: "{\"collection\":{\"elementtype\":{\"primitive\":\"string\"},\"kind\":\"array\"}}", isOverride: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "jwtConfiguration", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.Apigatewayv2AuthorizerJwtConfiguration\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
