...
namespace aws
{
    [JsiiInterface(nativeType: typeof(IIotThingConfig), fullyQualifiedName: "aws.IotThingConfig")]
    public interface IIotThingConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IIotThingConfig), fullyQualifiedName: "aws.IotThingConfig")]
        internal sealed class _Proxy : DeputyBase, aws.IIotThingConfig
        {
