...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.DatasyncLocationEfsConfig")]
    public class DatasyncLocationEfsConfig : aws.IDatasyncLocationEfsConfig
    {
        /// <summary>ec2_config block.</summary>
        [JsiiProperty(name: "ec2Config", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.DatasyncLocationEfsEc2Config\"},\"kind\":\"array\"}}", isOverride: true)]
