...
namespace aws
{
    [JsiiInterface(nativeType: typeof(ISecurityGroupEgress), fullyQualifiedName: "aws.SecurityGroupEgress")]
    public interface ISecurityGroupEgress
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ISecurityGroupEgress), fullyQualifiedName: "aws.SecurityGroupEgress")]
        internal sealed class _Proxy : DeputyBase, aws.ISecurityGroupEgress
        {
