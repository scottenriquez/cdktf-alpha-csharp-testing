...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.DataAwsAmiConfig")]
    public class DataAwsAmiConfig : aws.IDataAwsAmiConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "filter", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.DataAwsAmiFilter\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
