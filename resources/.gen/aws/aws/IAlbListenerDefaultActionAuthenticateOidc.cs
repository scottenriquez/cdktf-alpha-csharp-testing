...
namespace aws
{
    [JsiiInterface(nativeType: typeof(IAlbListenerDefaultActionAuthenticateOidc), fullyQualifiedName: "aws.AlbListenerDefaultActionAuthenticateOidc")]
    public interface IAlbListenerDefaultActionAuthenticateOidc
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IAlbListenerDefaultActionAuthenticateOidc), fullyQualifiedName: "aws.AlbListenerDefaultActionAuthenticateOidc")]
        internal sealed class _Proxy : DeputyBase, aws.IAlbListenerDefaultActionAuthenticateOidc
        {
