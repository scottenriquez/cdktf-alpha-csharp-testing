...
namespace aws
{
    [JsiiInterface(nativeType: typeof(INeptuneEventSubscriptionConfig), fullyQualifiedName: "aws.NeptuneEventSubscriptionConfig")]
    public interface INeptuneEventSubscriptionConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.NeptuneEventSubscriptionTimeouts\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.INeptuneEventSubscriptionTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(INeptuneEventSubscriptionConfig), fullyQualifiedName: "aws.NeptuneEventSubscriptionConfig")]
        internal sealed class _Proxy : DeputyBase, aws.INeptuneEventSubscriptionConfig
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.NeptuneEventSubscriptionTimeouts\"}", isOptional: true)]
            public aws.INeptuneEventSubscriptionTimeouts? Timeouts
            {
