...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.DataAwsTransferServer), fullyQualifiedName: "aws.DataAwsTransferServer", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.DataAwsTransferServerConfig\"}}]")]
    public class DataAwsTransferServer : HashiCorp.Cdktf.TerraformDataSource
    {
        public DataAwsTransferServer(Constructs.Construct scope, string id, aws.IDataAwsTransferServerConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
