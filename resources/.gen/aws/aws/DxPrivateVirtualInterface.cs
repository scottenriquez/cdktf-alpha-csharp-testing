...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.DxPrivateVirtualInterface), fullyQualifiedName: "aws.DxPrivateVirtualInterface", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.DxPrivateVirtualInterfaceConfig\"}}]")]
    public class DxPrivateVirtualInterface : HashiCorp.Cdktf.TerraformResource
    {
        public DxPrivateVirtualInterface(Constructs.Construct scope, string id, aws.IDxPrivateVirtualInterfaceConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "timeoutsInput", typeJson: "{\"fqn\":\"aws.DxPrivateVirtualInterfaceTimeouts\"}", isOptional: true)]
        public virtual aws.IDxPrivateVirtualInterfaceTimeouts? TimeoutsInput
        {
            get => GetInstanceProperty<aws.IDxPrivateVirtualInterfaceTimeouts?>();
        }
        ...
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.DxPrivateVirtualInterfaceTimeouts\"}")]
        public virtual aws.IDxPrivateVirtualInterfaceTimeouts Timeouts
        {
            get => GetInstanceProperty<aws.IDxPrivateVirtualInterfaceTimeouts>()!;
            set => SetInstanceProperty(value);
        }
