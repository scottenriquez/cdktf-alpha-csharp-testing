...
namespace aws
{
    [JsiiInterface(nativeType: typeof(IOpsworksGangliaLayerConfig), fullyQualifiedName: "aws.OpsworksGangliaLayerConfig")]
    public interface IOpsworksGangliaLayerConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        [JsiiProperty(name: "ebsVolume", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.OpsworksGangliaLayerEbsVolume\"},\"kind\":\"array\"}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.IOpsworksGangliaLayerEbsVolume[]? EbsVolume
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IOpsworksGangliaLayerConfig), fullyQualifiedName: "aws.OpsworksGangliaLayerConfig")]
        internal sealed class _Proxy : DeputyBase, aws.IOpsworksGangliaLayerConfig
        {
