...
namespace aws
{
    [JsiiInterface(nativeType: typeof(IVpcEndpointServiceConfig), fullyQualifiedName: "aws.VpcEndpointServiceConfig")]
    public interface IVpcEndpointServiceConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IVpcEndpointServiceConfig), fullyQualifiedName: "aws.VpcEndpointServiceConfig")]
        internal sealed class _Proxy : DeputyBase, aws.IVpcEndpointServiceConfig
        {
