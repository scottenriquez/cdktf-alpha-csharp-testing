...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.CloudfrontDistributionCacheBehavior")]
    public class CloudfrontDistributionCacheBehavior : aws.ICloudfrontDistributionCacheBehavior
    {
        ...
        [JsiiProperty(name: "forwardedValues", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.CloudfrontDistributionCacheBehaviorForwardedValues\"},\"kind\":\"array\"}}", isOverride: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "lambdaFunctionAssociation", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.CloudfrontDistributionCacheBehaviorLambdaFunctionAssociation\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
