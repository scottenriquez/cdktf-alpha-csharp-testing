...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.AthenaDatabaseConfig")]
    public class AthenaDatabaseConfig : aws.IAthenaDatabaseConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "encryptionConfiguration", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.AthenaDatabaseEncryptionConfiguration\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
