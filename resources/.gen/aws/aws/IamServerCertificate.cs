...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.IamServerCertificate), fullyQualifiedName: "aws.IamServerCertificate", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.IamServerCertificateConfig\"}}]")]
    public class IamServerCertificate : HashiCorp.Cdktf.TerraformResource
    {
        public IamServerCertificate(Constructs.Construct scope, string id, aws.IIamServerCertificateConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        [JsiiProperty(name: "certificateBodyInput", typeJson: "{\"primitive\":\"string\"}")]
        ...
        [JsiiProperty(name: "privateKeyInput", typeJson: "{\"primitive\":\"string\"}")]
