...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.GlueTriggerConfig")]
    public class GlueTriggerConfig : aws.IGlueTriggerConfig
    {
        /// <summary>actions block.</summary>
        [JsiiProperty(name: "actions", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.GlueTriggerActions\"},\"kind\":\"array\"}}", isOverride: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "predicate", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.GlueTriggerPredicate\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.GlueTriggerTimeouts\"}", isOptional: true, isOverride: true)]
