...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.IamUserLoginProfileConfig")]
    public class IamUserLoginProfileConfig : aws.IIamUserLoginProfileConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "passwordResetRequired", typeJson: "{\"primitive\":\"boolean\"}", isOptional: true, isOverride: true)]
