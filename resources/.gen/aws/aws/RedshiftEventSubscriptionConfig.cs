...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.RedshiftEventSubscriptionConfig")]
    public class RedshiftEventSubscriptionConfig : aws.IRedshiftEventSubscriptionConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.RedshiftEventSubscriptionTimeouts\"}", isOptional: true, isOverride: true)]
