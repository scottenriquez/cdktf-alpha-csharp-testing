...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.DxPublicVirtualInterfaceConfig")]
    public class DxPublicVirtualInterfaceConfig : aws.IDxPublicVirtualInterfaceConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.DxPublicVirtualInterfaceTimeouts\"}", isOptional: true, isOverride: true)]
        public aws.IDxPublicVirtualInterfaceTimeouts? Timeouts
        {
            get;
            set;
        }
