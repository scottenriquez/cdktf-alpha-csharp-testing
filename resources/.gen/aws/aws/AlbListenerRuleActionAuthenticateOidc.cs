...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.AlbListenerRuleActionAuthenticateOidc")]
    public class AlbListenerRuleActionAuthenticateOidc : aws.IAlbListenerRuleActionAuthenticateOidc
    {
