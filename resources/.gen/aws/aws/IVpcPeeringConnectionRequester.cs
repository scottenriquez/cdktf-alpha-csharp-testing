...
namespace aws
{
    [JsiiInterface(nativeType: typeof(IVpcPeeringConnectionRequester), fullyQualifiedName: "aws.VpcPeeringConnectionRequester")]
    public interface IVpcPeeringConnectionRequester
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IVpcPeeringConnectionRequester), fullyQualifiedName: "aws.VpcPeeringConnectionRequester")]
        internal sealed class _Proxy : DeputyBase, aws.IVpcPeeringConnectionRequester
        {
