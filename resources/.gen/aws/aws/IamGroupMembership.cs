...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.IamGroupMembership), fullyQualifiedName: "aws.IamGroupMembership", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.IamGroupMembershipConfig\"}}]")]
    public class IamGroupMembership : HashiCorp.Cdktf.TerraformResource
    {
        public IamGroupMembership(Constructs.Construct scope, string id, aws.IIamGroupMembershipConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        [JsiiProperty(name: "usersInput", typeJson: "{\"collection\":{\"elementtype\":{\"primitive\":\"string\"},\"kind\":\"array\"}}")]
