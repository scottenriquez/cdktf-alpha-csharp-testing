...
namespace aws
{
    [JsiiInterface(nativeType: typeof(IAlbListenerRuleActionAuthenticateCognito), fullyQualifiedName: "aws.AlbListenerRuleActionAuthenticateCognito")]
    public interface IAlbListenerRuleActionAuthenticateCognito
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IAlbListenerRuleActionAuthenticateCognito), fullyQualifiedName: "aws.AlbListenerRuleActionAuthenticateCognito")]
        internal sealed class _Proxy : DeputyBase, aws.IAlbListenerRuleActionAuthenticateCognito
        {
