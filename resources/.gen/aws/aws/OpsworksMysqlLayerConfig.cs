...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.OpsworksMysqlLayerConfig")]
    public class OpsworksMysqlLayerConfig : aws.IOpsworksMysqlLayerConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "ebsVolume", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.OpsworksMysqlLayerEbsVolume\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "rootPasswordOnAllInstances", typeJson: "{\"primitive\":\"boolean\"}", isOptional: true, isOverride: true)]
