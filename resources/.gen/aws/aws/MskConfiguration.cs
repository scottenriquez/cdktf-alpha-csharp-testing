...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.MskConfiguration), fullyQualifiedName: "aws.MskConfiguration", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.MskConfigurationConfig\"}}]")]
    public class MskConfiguration : HashiCorp.Cdktf.TerraformResource
    {
        public MskConfiguration(Constructs.Construct scope, string id, aws.IMskConfigurationConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        [JsiiProperty(name: "kafkaVersionsInput", typeJson: "{\"collection\":{\"elementtype\":{\"primitive\":\"string\"},\"kind\":\"array\"}}")]
        ...
        [JsiiProperty(name: "serverPropertiesInput", typeJson: "{\"primitive\":\"string\"}")]
