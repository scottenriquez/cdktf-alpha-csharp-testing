...
namespace aws
{
    [JsiiByValue(fqn: "aws.EipConfig")]
    public class EipConfig : aws.IEipConfig
    {
        [JsiiOptional]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.EipTimeouts\"}", isOptional: true, isOverride: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "vpc", typeJson: "{\"primitive\":\"boolean\"}", isOptional: true, isOverride: true)]
        public bool? Vpc
        {
            get;
            set;
