...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.AthenaWorkgroupConfig")]
    public class AthenaWorkgroupConfig : aws.IAthenaWorkgroupConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "configuration", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.AthenaWorkgroupConfiguration\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
