...
namespace aws
{
    [JsiiInterface(nativeType: typeof(ILbConfig), fullyQualifiedName: "aws.LbConfig")]
    public interface ILbConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        /// <summary>access_logs block.</summary>
        [JsiiProperty(name: "accessLogs", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.LbAccessLogs\"},\"kind\":\"array\"}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.ILbAccessLogs[]? AccessLogs
        {
            get
            {
                return null;
        ...
        [JsiiProperty(name: "subnetMapping", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.LbSubnetMapping\"},\"kind\":\"array\"}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.ILbSubnetMapping[]? SubnetMapping
        {
            get
            {
                return null;
        ...
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.LbTimeouts\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.ILbTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(ILbConfig), fullyQualifiedName: "aws.LbConfig")]
        internal sealed class _Proxy : DeputyBase, aws.ILbConfig
        {
