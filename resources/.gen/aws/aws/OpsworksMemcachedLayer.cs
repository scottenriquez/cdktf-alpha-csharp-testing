...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.OpsworksMemcachedLayer), fullyQualifiedName: "aws.OpsworksMemcachedLayer", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.OpsworksMemcachedLayerConfig\"}}]")]
    public class OpsworksMemcachedLayer : HashiCorp.Cdktf.TerraformResource
    {
        public OpsworksMemcachedLayer(Constructs.Construct scope, string id, aws.IOpsworksMemcachedLayerConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "ebsVolumeInput", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.OpsworksMemcachedLayerEbsVolume\"},\"kind\":\"array\"}}", isOptional: true)]
        public virtual aws.IOpsworksMemcachedLayerEbsVolume[]? EbsVolumeInput
        {
            get => GetInstanceProperty<aws.IOpsworksMemcachedLayerEbsVolume[]?>();
        }
        ...
        [JsiiProperty(name: "ebsVolume", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.OpsworksMemcachedLayerEbsVolume\"},\"kind\":\"array\"}}")]
        public virtual aws.IOpsworksMemcachedLayerEbsVolume[] EbsVolume
        {
            get => GetInstanceProperty<aws.IOpsworksMemcachedLayerEbsVolume[]>()!;
            set => SetInstanceProperty(value);
        }
