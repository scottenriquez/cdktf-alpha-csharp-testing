...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.GuarddutyThreatintelsetConfig")]
    public class GuarddutyThreatintelsetConfig : aws.IGuarddutyThreatintelsetConfig
    {
        [JsiiProperty(name: "activate", typeJson: "{\"primitive\":\"boolean\"}", isOverride: true)]
