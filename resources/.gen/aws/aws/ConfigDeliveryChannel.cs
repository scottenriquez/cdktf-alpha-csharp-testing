...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.ConfigDeliveryChannel), fullyQualifiedName: "aws.ConfigDeliveryChannel", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.ConfigDeliveryChannelConfig\"}}]")]
    public class ConfigDeliveryChannel : HashiCorp.Cdktf.TerraformResource
    {
        public ConfigDeliveryChannel(Constructs.Construct scope, string id, aws.IConfigDeliveryChannelConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "snapshotDeliveryPropertiesInput", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.ConfigDeliveryChannelSnapshotDeliveryProperties\"},\"kind\":\"array\"}}", isOptional: true)]
        public virtual aws.IConfigDeliveryChannelSnapshotDeliveryProperties[]? SnapshotDeliveryPropertiesInput
        {
        ...
        [JsiiProperty(name: "snapshotDeliveryProperties", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.ConfigDeliveryChannelSnapshotDeliveryProperties\"},\"kind\":\"array\"}}")]
        public virtual aws.IConfigDeliveryChannelSnapshotDeliveryProperties[] SnapshotDeliveryProperties
        {
            get => GetInstanceProperty<aws.IConfigDeliveryChannelSnapshotDeliveryProperties[]>()!;
            set => SetInstanceProperty(value);
        }
