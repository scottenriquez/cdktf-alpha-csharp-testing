...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.KinesisVideoStreamConfig")]
    public class KinesisVideoStreamConfig : aws.IKinesisVideoStreamConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.KinesisVideoStreamTimeouts\"}", isOptional: true, isOverride: true)]
