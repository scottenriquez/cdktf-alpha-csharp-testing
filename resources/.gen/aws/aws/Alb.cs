...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.Alb), fullyQualifiedName: "aws.Alb", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"optional\":true,\"type\":{\"fqn\":\"aws.AlbConfig\"}}]")]
    public class Alb : HashiCorp.Cdktf.TerraformResource
    {
        public Alb(Constructs.Construct scope, string id, aws.IAlbConfig? config = null): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "accessLogsInput", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.AlbAccessLogs\"},\"kind\":\"array\"}}", isOptional: true)]
        public virtual aws.IAlbAccessLogs[]? AccessLogsInput
        {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "subnetMappingInput", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.AlbSubnetMapping\"},\"kind\":\"array\"}}", isOptional: true)]
        public virtual aws.IAlbSubnetMapping[]? SubnetMappingInput
        {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "timeoutsInput", typeJson: "{\"fqn\":\"aws.AlbTimeouts\"}", isOptional: true)]
        public virtual aws.IAlbTimeouts? TimeoutsInput
        {
            get => GetInstanceProperty<aws.IAlbTimeouts?>();
        }

        [JsiiProperty(name: "accessLogs", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.AlbAccessLogs\"},\"kind\":\"array\"}}")]
        public virtual aws.IAlbAccessLogs[] AccessLogs
        {
            get => GetInstanceProperty<aws.IAlbAccessLogs[]>()!;
        ...
        [JsiiProperty(name: "subnetMapping", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.AlbSubnetMapping\"},\"kind\":\"array\"}}")]
        public virtual aws.IAlbSubnetMapping[] SubnetMapping
        {
            get => GetInstanceProperty<aws.IAlbSubnetMapping[]>()!;
            set => SetInstanceProperty(value);
        }
        ...
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.AlbTimeouts\"}")]
        public virtual aws.IAlbTimeouts Timeouts
        {
            get => GetInstanceProperty<aws.IAlbTimeouts>()!;
            set => SetInstanceProperty(value);
        }
