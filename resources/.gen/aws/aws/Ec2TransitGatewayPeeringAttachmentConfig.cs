...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.Ec2TransitGatewayPeeringAttachmentConfig")]
    public class Ec2TransitGatewayPeeringAttachmentConfig : aws.IEc2TransitGatewayPeeringAttachmentConfig
    {
