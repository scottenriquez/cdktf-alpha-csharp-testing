...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.GlueTrigger), fullyQualifiedName: "aws.GlueTrigger", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.GlueTriggerConfig\"}}]")]
    public class GlueTrigger : HashiCorp.Cdktf.TerraformResource
    {
        public GlueTrigger(Constructs.Construct scope, string id, aws.IGlueTriggerConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        [JsiiProperty(name: "actionsInput", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.GlueTriggerActions\"},\"kind\":\"array\"}}")]
        public virtual aws.IGlueTriggerActions[] ActionsInput
        {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "predicateInput", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.GlueTriggerPredicate\"},\"kind\":\"array\"}}", isOptional: true)]
        public virtual aws.IGlueTriggerPredicate[]? PredicateInput
        {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "timeoutsInput", typeJson: "{\"fqn\":\"aws.GlueTriggerTimeouts\"}", isOptional: true)]
        public virtual aws.IGlueTriggerTimeouts? TimeoutsInput
        {
        ...
        public virtual aws.IGlueTriggerActions[] Actions
        {
            get => GetInstanceProperty<aws.IGlueTriggerActions[]>()!;
        ...
        [JsiiProperty(name: "predicate", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.GlueTriggerPredicate\"},\"kind\":\"array\"}}")]
        public virtual aws.IGlueTriggerPredicate[] Predicate
        {
            get => GetInstanceProperty<aws.IGlueTriggerPredicate[]>()!;
            set => SetInstanceProperty(value);
        }
        ...
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.GlueTriggerTimeouts\"}")]
        public virtual aws.IGlueTriggerTimeouts Timeouts
        {
            get => GetInstanceProperty<aws.IGlueTriggerTimeouts>()!;
            set => SetInstanceProperty(value);
        }
