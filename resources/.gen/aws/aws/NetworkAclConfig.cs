...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.NetworkAclConfig")]
    public class NetworkAclConfig : aws.INetworkAclConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "egress", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.NetworkAclEgress\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "ingress", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.NetworkAclIngress\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
