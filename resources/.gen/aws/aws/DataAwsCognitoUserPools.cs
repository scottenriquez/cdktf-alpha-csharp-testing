...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.DataAwsCognitoUserPools), fullyQualifiedName: "aws.DataAwsCognitoUserPools", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.DataAwsCognitoUserPoolsConfig\"}}]")]
    public class DataAwsCognitoUserPools : HashiCorp.Cdktf.TerraformDataSource
    {
        public DataAwsCognitoUserPools(Constructs.Construct scope, string id, aws.IDataAwsCognitoUserPoolsConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
