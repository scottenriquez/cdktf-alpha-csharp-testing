...
namespace aws
{
    [JsiiInterface(nativeType: typeof(IDefaultSecurityGroupEgress), fullyQualifiedName: "aws.DefaultSecurityGroupEgress")]
    public interface IDefaultSecurityGroupEgress
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDefaultSecurityGroupEgress), fullyQualifiedName: "aws.DefaultSecurityGroupEgress")]
        internal sealed class _Proxy : DeputyBase, aws.IDefaultSecurityGroupEgress
        {
