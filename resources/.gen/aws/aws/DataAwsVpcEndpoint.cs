...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.DataAwsVpcEndpoint), fullyQualifiedName: "aws.DataAwsVpcEndpoint", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"optional\":true,\"type\":{\"fqn\":\"aws.DataAwsVpcEndpointConfig\"}}]")]
    public class DataAwsVpcEndpoint : HashiCorp.Cdktf.TerraformDataSource
    {
        public DataAwsVpcEndpoint(Constructs.Construct scope, string id, aws.IDataAwsVpcEndpointConfig? config = null): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        [JsiiMethod(name: "dnsEntry", returnsJson: "{\"type\":{\"fqn\":\"aws.DataAwsVpcEndpointDnsEntry\"}}", parametersJson: "[{\"name\":\"index\",\"type\":{\"primitive\":\"string\"}}]")]
        public virtual aws.DataAwsVpcEndpointDnsEntry DnsEntry(string index)
        {
            return InvokeInstanceMethod<aws.DataAwsVpcEndpointDnsEntry>(new System.Type[]{typeof(string)}, new object[]{index})!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "filterInput", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.DataAwsVpcEndpointFilter\"},\"kind\":\"array\"}}", isOptional: true)]
        public virtual aws.IDataAwsVpcEndpointFilter[]? FilterInput
        {
        ...
        [JsiiProperty(name: "filter", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.DataAwsVpcEndpointFilter\"},\"kind\":\"array\"}}")]
        public virtual aws.IDataAwsVpcEndpointFilter[] Filter
        {
            get => GetInstanceProperty<aws.IDataAwsVpcEndpointFilter[]>()!;
