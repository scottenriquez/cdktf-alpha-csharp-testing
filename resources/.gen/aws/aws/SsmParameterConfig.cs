...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.SsmParameterConfig")]
    public class SsmParameterConfig : aws.ISsmParameterConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "overwrite", typeJson: "{\"primitive\":\"boolean\"}", isOptional: true, isOverride: true)]
