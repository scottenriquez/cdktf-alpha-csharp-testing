...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.PinpointGcmChannel), fullyQualifiedName: "aws.PinpointGcmChannel", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.PinpointGcmChannelConfig\"}}]")]
    public class PinpointGcmChannel : HashiCorp.Cdktf.TerraformResource
    {
        public PinpointGcmChannel(Constructs.Construct scope, string id, aws.IPinpointGcmChannelConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
