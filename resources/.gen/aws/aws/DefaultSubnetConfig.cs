...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.DefaultSubnetConfig")]
    public class DefaultSubnetConfig : aws.IDefaultSubnetConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.DefaultSubnetTimeouts\"}", isOptional: true, isOverride: true)]
