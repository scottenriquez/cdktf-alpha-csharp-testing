...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.DataAwsSsmPatchBaselineConfig")]
    public class DataAwsSsmPatchBaselineConfig : aws.IDataAwsSsmPatchBaselineConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "defaultBaseline", typeJson: "{\"primitive\":\"boolean\"}", isOptional: true, isOverride: true)]
