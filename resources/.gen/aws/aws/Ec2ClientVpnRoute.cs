...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.Ec2ClientVpnRoute), fullyQualifiedName: "aws.Ec2ClientVpnRoute", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.Ec2ClientVpnRouteConfig\"}}]")]
    public class Ec2ClientVpnRoute : HashiCorp.Cdktf.TerraformResource
    {
        public Ec2ClientVpnRoute(Constructs.Construct scope, string id, aws.IEc2ClientVpnRouteConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        [JsiiProperty(name: "targetVpcSubnetIdInput", typeJson: "{\"primitive\":\"string\"}")]
