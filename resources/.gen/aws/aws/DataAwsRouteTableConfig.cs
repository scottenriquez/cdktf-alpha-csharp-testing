...
namespace aws
{
    [JsiiByValue(fqn: "aws.DataAwsRouteTableConfig")]
    public class DataAwsRouteTableConfig : aws.IDataAwsRouteTableConfig
    {
        /// <summary>filter block.</summary>
        [JsiiOptional]
        [JsiiProperty(name: "filter", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.DataAwsRouteTableFilter\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
