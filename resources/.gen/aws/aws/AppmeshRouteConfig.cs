...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.AppmeshRouteConfig")]
    public class AppmeshRouteConfig : aws.IAppmeshRouteConfig
    {
        ...
        [JsiiProperty(name: "spec", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.AppmeshRouteSpec\"},\"kind\":\"array\"}}", isOverride: true)]
