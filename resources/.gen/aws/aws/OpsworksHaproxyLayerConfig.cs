...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.OpsworksHaproxyLayerConfig")]
    public class OpsworksHaproxyLayerConfig : aws.IOpsworksHaproxyLayerConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "ebsVolume", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.OpsworksHaproxyLayerEbsVolume\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "statsEnabled", typeJson: "{\"primitive\":\"boolean\"}", isOptional: true, isOverride: true)]
