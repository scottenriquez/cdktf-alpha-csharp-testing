...
namespace aws
{
    [JsiiInterface(nativeType: typeof(IDxHostedPrivateVirtualInterfaceConfig), fullyQualifiedName: "aws.DxHostedPrivateVirtualInterfaceConfig")]
    public interface IDxHostedPrivateVirtualInterfaceConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.DxHostedPrivateVirtualInterfaceTimeouts\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.IDxHostedPrivateVirtualInterfaceTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDxHostedPrivateVirtualInterfaceConfig), fullyQualifiedName: "aws.DxHostedPrivateVirtualInterfaceConfig")]
        internal sealed class _Proxy : DeputyBase, aws.IDxHostedPrivateVirtualInterfaceConfig
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.DxHostedPrivateVirtualInterfaceTimeouts\"}", isOptional: true)]
            public aws.IDxHostedPrivateVirtualInterfaceTimeouts? Timeouts
            {
