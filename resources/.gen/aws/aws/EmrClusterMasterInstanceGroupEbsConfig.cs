...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.EmrClusterMasterInstanceGroupEbsConfig")]
    public class EmrClusterMasterInstanceGroupEbsConfig : aws.IEmrClusterMasterInstanceGroupEbsConfig
    {
