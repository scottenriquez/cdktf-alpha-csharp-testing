...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.WorklinkWebsiteCertificateAuthorityAssociationConfig")]
    public class WorklinkWebsiteCertificateAuthorityAssociationConfig : aws.IWorklinkWebsiteCertificateAuthorityAssociationConfig
    {
