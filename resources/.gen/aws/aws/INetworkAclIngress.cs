...
namespace aws
{
    [JsiiInterface(nativeType: typeof(INetworkAclIngress), fullyQualifiedName: "aws.NetworkAclIngress")]
    public interface INetworkAclIngress
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(INetworkAclIngress), fullyQualifiedName: "aws.NetworkAclIngress")]
        internal sealed class _Proxy : DeputyBase, aws.INetworkAclIngress
        {
