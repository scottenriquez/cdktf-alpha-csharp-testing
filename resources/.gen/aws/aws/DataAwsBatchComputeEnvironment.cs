...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.DataAwsBatchComputeEnvironment), fullyQualifiedName: "aws.DataAwsBatchComputeEnvironment", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.DataAwsBatchComputeEnvironmentConfig\"}}]")]
    public class DataAwsBatchComputeEnvironment : HashiCorp.Cdktf.TerraformDataSource
    {
        public DataAwsBatchComputeEnvironment(Constructs.Construct scope, string id, aws.IDataAwsBatchComputeEnvironmentConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        [JsiiProperty(name: "computeEnvironmentNameInput", typeJson: "{\"primitive\":\"string\"}")]
