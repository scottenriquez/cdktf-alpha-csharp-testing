...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.DataAwsIamRole), fullyQualifiedName: "aws.DataAwsIamRole", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.DataAwsIamRoleConfig\"}}]")]
    public class DataAwsIamRole : HashiCorp.Cdktf.TerraformDataSource
    {
        public DataAwsIamRole(Constructs.Construct scope, string id, aws.IDataAwsIamRoleConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
