...
namespace aws
{
    [JsiiByValue(fqn: "aws.DataAwsSubnetConfig")]
    public class DataAwsSubnetConfig : aws.IDataAwsSubnetConfig
    {
        [JsiiOptional]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "defaultForAz", typeJson: "{\"primitive\":\"boolean\"}", isOptional: true, isOverride: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "filter", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.DataAwsSubnetFilter\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
