...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.DataAwsRedshiftCluster), fullyQualifiedName: "aws.DataAwsRedshiftCluster", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.DataAwsRedshiftClusterConfig\"}}]")]
    public class DataAwsRedshiftCluster : HashiCorp.Cdktf.TerraformDataSource
    {
        public DataAwsRedshiftCluster(Constructs.Construct scope, string id, aws.IDataAwsRedshiftClusterConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
