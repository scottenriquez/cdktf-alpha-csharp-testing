...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.LbListenerRuleActionAuthenticateCognito")]
    public class LbListenerRuleActionAuthenticateCognito : aws.ILbListenerRuleActionAuthenticateCognito
    {
