...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.DmsEventSubscription), fullyQualifiedName: "aws.DmsEventSubscription", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.DmsEventSubscriptionConfig\"}}]")]
    public class DmsEventSubscription : HashiCorp.Cdktf.TerraformResource
    {
        public DmsEventSubscription(Constructs.Construct scope, string id, aws.IDmsEventSubscriptionConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        [JsiiProperty(name: "eventCategoriesInput", typeJson: "{\"collection\":{\"elementtype\":{\"primitive\":\"string\"},\"kind\":\"array\"}}")]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "timeoutsInput", typeJson: "{\"fqn\":\"aws.DmsEventSubscriptionTimeouts\"}", isOptional: true)]
        public virtual aws.IDmsEventSubscriptionTimeouts? TimeoutsInput
        {
        ...
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.DmsEventSubscriptionTimeouts\"}")]
        public virtual aws.IDmsEventSubscriptionTimeouts Timeouts
        {
            get => GetInstanceProperty<aws.IDmsEventSubscriptionTimeouts>()!;
            set => SetInstanceProperty(value);
        }
