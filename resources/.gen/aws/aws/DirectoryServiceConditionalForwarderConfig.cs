...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.DirectoryServiceConditionalForwarderConfig")]
    public class DirectoryServiceConditionalForwarderConfig : aws.IDirectoryServiceConditionalForwarderConfig
    {
