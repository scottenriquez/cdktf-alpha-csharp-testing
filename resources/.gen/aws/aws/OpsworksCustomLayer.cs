...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.OpsworksCustomLayer), fullyQualifiedName: "aws.OpsworksCustomLayer", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.OpsworksCustomLayerConfig\"}}]")]
    public class OpsworksCustomLayer : HashiCorp.Cdktf.TerraformResource
    {
        public OpsworksCustomLayer(Constructs.Construct scope, string id, aws.IOpsworksCustomLayerConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        [JsiiProperty(name: "shortNameInput", typeJson: "{\"primitive\":\"string\"}")]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "ebsVolumeInput", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.OpsworksCustomLayerEbsVolume\"},\"kind\":\"array\"}}", isOptional: true)]
        public virtual aws.IOpsworksCustomLayerEbsVolume[]? EbsVolumeInput
        {
        ...
        [JsiiProperty(name: "ebsVolume", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.OpsworksCustomLayerEbsVolume\"},\"kind\":\"array\"}}")]
        public virtual aws.IOpsworksCustomLayerEbsVolume[] EbsVolume
        {
            get => GetInstanceProperty<aws.IOpsworksCustomLayerEbsVolume[]>()!;
            set => SetInstanceProperty(value);
        }
