...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.OpsworksNodejsAppLayer), fullyQualifiedName: "aws.OpsworksNodejsAppLayer", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.OpsworksNodejsAppLayerConfig\"}}]")]
    public class OpsworksNodejsAppLayer : HashiCorp.Cdktf.TerraformResource
    {
        public OpsworksNodejsAppLayer(Constructs.Construct scope, string id, aws.IOpsworksNodejsAppLayerConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "ebsVolumeInput", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.OpsworksNodejsAppLayerEbsVolume\"},\"kind\":\"array\"}}", isOptional: true)]
        public virtual aws.IOpsworksNodejsAppLayerEbsVolume[]? EbsVolumeInput
        {
        ...
        [JsiiProperty(name: "ebsVolume", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.OpsworksNodejsAppLayerEbsVolume\"},\"kind\":\"array\"}}")]
        public virtual aws.IOpsworksNodejsAppLayerEbsVolume[] EbsVolume
        {
            get => GetInstanceProperty<aws.IOpsworksNodejsAppLayerEbsVolume[]>()!;
            set => SetInstanceProperty(value);
        }
