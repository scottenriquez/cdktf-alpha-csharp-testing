...
namespace aws
{
    [JsiiInterface(nativeType: typeof(IAmiEbsBlockDevice), fullyQualifiedName: "aws.AmiEbsBlockDevice")]
    public interface IAmiEbsBlockDevice
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IAmiEbsBlockDevice), fullyQualifiedName: "aws.AmiEbsBlockDevice")]
        internal sealed class _Proxy : DeputyBase, aws.IAmiEbsBlockDevice
        {
