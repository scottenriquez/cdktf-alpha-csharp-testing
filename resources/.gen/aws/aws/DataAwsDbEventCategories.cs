...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.DataAwsDbEventCategories), fullyQualifiedName: "aws.DataAwsDbEventCategories", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"optional\":true,\"type\":{\"fqn\":\"aws.DataAwsDbEventCategoriesConfig\"}}]")]
    public class DataAwsDbEventCategories : HashiCorp.Cdktf.TerraformDataSource
    {
        public DataAwsDbEventCategories(Constructs.Construct scope, string id, aws.IDataAwsDbEventCategoriesConfig? config = null): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
