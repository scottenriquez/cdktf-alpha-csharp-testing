...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.OpsworksMemcachedLayerConfig")]
    public class OpsworksMemcachedLayerConfig : aws.IOpsworksMemcachedLayerConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "ebsVolume", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.OpsworksMemcachedLayerEbsVolume\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
