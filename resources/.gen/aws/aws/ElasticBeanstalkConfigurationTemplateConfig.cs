...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.ElasticBeanstalkConfigurationTemplateConfig")]
    public class ElasticBeanstalkConfigurationTemplateConfig : aws.IElasticBeanstalkConfigurationTemplateConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "setting", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.ElasticBeanstalkConfigurationTemplateSetting\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
