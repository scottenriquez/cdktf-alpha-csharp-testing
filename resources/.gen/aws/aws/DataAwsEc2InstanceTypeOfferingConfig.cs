...
namespace aws
{
    [JsiiByValue(fqn: "aws.DataAwsEc2InstanceTypeOfferingConfig")]
    public class DataAwsEc2InstanceTypeOfferingConfig : aws.IDataAwsEc2InstanceTypeOfferingConfig
    {
        /// <summary>filter block.</summary>
        [JsiiOptional]
        [JsiiProperty(name: "filter", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.DataAwsEc2InstanceTypeOfferingFilter\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
