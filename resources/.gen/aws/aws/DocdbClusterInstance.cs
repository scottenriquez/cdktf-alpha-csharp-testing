...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.DocdbClusterInstance), fullyQualifiedName: "aws.DocdbClusterInstance", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.DocdbClusterInstanceConfig\"}}]")]
    public class DocdbClusterInstance : HashiCorp.Cdktf.TerraformResource
    {
        public DocdbClusterInstance(Constructs.Construct scope, string id, aws.IDocdbClusterInstanceConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "timeoutsInput", typeJson: "{\"fqn\":\"aws.DocdbClusterInstanceTimeouts\"}", isOptional: true)]
        public virtual aws.IDocdbClusterInstanceTimeouts? TimeoutsInput
        {
        ...
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.DocdbClusterInstanceTimeouts\"}")]
        public virtual aws.IDocdbClusterInstanceTimeouts Timeouts
        {
            get => GetInstanceProperty<aws.IDocdbClusterInstanceTimeouts>()!;
            set => SetInstanceProperty(value);
        }
