...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.Ec2TransitGateway), fullyQualifiedName: "aws.Ec2TransitGateway", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"optional\":true,\"type\":{\"fqn\":\"aws.Ec2TransitGatewayConfig\"}}]")]
    public class Ec2TransitGateway : HashiCorp.Cdktf.TerraformResource
    {
        public Ec2TransitGateway(Constructs.Construct scope, string id, aws.IEc2TransitGatewayConfig? config = null): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
