...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.VpcEndpointConnectionNotificationConfig")]
    public class VpcEndpointConnectionNotificationConfig : aws.IVpcEndpointConnectionNotificationConfig
    {
