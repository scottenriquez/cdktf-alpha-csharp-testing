...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.CloudwatchEventRule), fullyQualifiedName: "aws.CloudwatchEventRule", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"optional\":true,\"type\":{\"fqn\":\"aws.CloudwatchEventRuleConfig\"}}]")]
    public class CloudwatchEventRule : HashiCorp.Cdktf.TerraformResource
    {
        public CloudwatchEventRule(Constructs.Construct scope, string id, aws.ICloudwatchEventRuleConfig? config = null): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
