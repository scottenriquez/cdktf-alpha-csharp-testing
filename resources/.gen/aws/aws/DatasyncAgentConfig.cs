...
namespace aws
{
    [JsiiByValue(fqn: "aws.DatasyncAgentConfig")]
    public class DatasyncAgentConfig : aws.IDatasyncAgentConfig
    {
        [JsiiOptional]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.DatasyncAgentTimeouts\"}", isOptional: true, isOverride: true)]
