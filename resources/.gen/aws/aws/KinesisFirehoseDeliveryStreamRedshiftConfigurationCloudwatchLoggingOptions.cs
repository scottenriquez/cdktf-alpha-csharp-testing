...
namespace aws
{
    [JsiiByValue(fqn: "aws.KinesisFirehoseDeliveryStreamRedshiftConfigurationCloudwatchLoggingOptions")]
    public class KinesisFirehoseDeliveryStreamRedshiftConfigurationCloudwatchLoggingOptions : aws.IKinesisFirehoseDeliveryStreamRedshiftConfigurationCloudwatchLoggingOptions
    {
        [JsiiOptional]
