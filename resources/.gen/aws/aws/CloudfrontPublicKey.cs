...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.CloudfrontPublicKey), fullyQualifiedName: "aws.CloudfrontPublicKey", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.CloudfrontPublicKeyConfig\"}}]")]
    public class CloudfrontPublicKey : HashiCorp.Cdktf.TerraformResource
    {
        public CloudfrontPublicKey(Constructs.Construct scope, string id, aws.ICloudfrontPublicKeyConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        [JsiiProperty(name: "encodedKeyInput", typeJson: "{\"primitive\":\"string\"}")]
