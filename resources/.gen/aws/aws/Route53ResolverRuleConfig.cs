...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.Route53ResolverRuleConfig")]
    public class Route53ResolverRuleConfig : aws.IRoute53ResolverRuleConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "targetIp", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.Route53ResolverRuleTargetIp\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.Route53ResolverRuleTimeouts\"}", isOptional: true, isOverride: true)]
