...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.PinpointApnsVoipChannel), fullyQualifiedName: "aws.PinpointApnsVoipChannel", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.PinpointApnsVoipChannelConfig\"}}]")]
    public class PinpointApnsVoipChannel : HashiCorp.Cdktf.TerraformResource
    {
        public PinpointApnsVoipChannel(Constructs.Construct scope, string id, aws.IPinpointApnsVoipChannelConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
