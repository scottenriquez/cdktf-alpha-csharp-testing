...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.DxConnection), fullyQualifiedName: "aws.DxConnection", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.DxConnectionConfig\"}}]")]
    public class DxConnection : HashiCorp.Cdktf.TerraformResource
    {
        public DxConnection(Constructs.Construct scope, string id, aws.IDxConnectionConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        [JsiiProperty(name: "bandwidthInput", typeJson: "{\"primitive\":\"string\"}")]
