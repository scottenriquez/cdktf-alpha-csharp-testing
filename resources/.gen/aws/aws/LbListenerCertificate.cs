...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.LbListenerCertificate), fullyQualifiedName: "aws.LbListenerCertificate", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.LbListenerCertificateConfig\"}}]")]
    public class LbListenerCertificate : HashiCorp.Cdktf.TerraformResource
    {
        public LbListenerCertificate(Constructs.Construct scope, string id, aws.ILbListenerCertificateConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
