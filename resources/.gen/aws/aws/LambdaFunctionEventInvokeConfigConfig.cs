...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.LambdaFunctionEventInvokeConfigConfig")]
    public class LambdaFunctionEventInvokeConfigConfig : aws.ILambdaFunctionEventInvokeConfigConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "destinationConfig", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.LambdaFunctionEventInvokeConfigDestinationConfig\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
