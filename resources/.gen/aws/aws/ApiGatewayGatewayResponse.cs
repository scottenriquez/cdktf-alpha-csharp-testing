...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.ApiGatewayGatewayResponse), fullyQualifiedName: "aws.ApiGatewayGatewayResponse", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.ApiGatewayGatewayResponseConfig\"}}]")]
    public class ApiGatewayGatewayResponse : HashiCorp.Cdktf.TerraformResource
    {
        public ApiGatewayGatewayResponse(Constructs.Construct scope, string id, aws.IApiGatewayGatewayResponseConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        [JsiiProperty(name: "responseTypeInput", typeJson: "{\"primitive\":\"string\"}")]
