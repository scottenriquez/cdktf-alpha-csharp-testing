...
namespace aws
{
    [JsiiByValue(fqn: "aws.SpotFleetRequestLaunchSpecificationRootBlockDevice")]
    public class SpotFleetRequestLaunchSpecificationRootBlockDevice : aws.ISpotFleetRequestLaunchSpecificationRootBlockDevice
    {
        [JsiiOptional]
