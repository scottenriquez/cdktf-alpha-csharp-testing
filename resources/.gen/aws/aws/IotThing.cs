...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.IotThing), fullyQualifiedName: "aws.IotThing", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.IotThingConfig\"}}]")]
    public class IotThing : HashiCorp.Cdktf.TerraformResource
    {
        public IotThing(Constructs.Construct scope, string id, aws.IIotThingConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
