...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.DataAwsKmsCiphertext), fullyQualifiedName: "aws.DataAwsKmsCiphertext", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.DataAwsKmsCiphertextConfig\"}}]")]
    public class DataAwsKmsCiphertext : HashiCorp.Cdktf.TerraformDataSource
    {
        public DataAwsKmsCiphertext(Constructs.Construct scope, string id, aws.IDataAwsKmsCiphertextConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
