...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.SpotInstanceRequestEphemeralBlockDevice")]
    public class SpotInstanceRequestEphemeralBlockDevice : aws.ISpotInstanceRequestEphemeralBlockDevice
    {
