...
namespace aws
{
    [JsiiInterface(nativeType: typeof(IDefaultVpcDhcpOptionsConfig), fullyQualifiedName: "aws.DefaultVpcDhcpOptionsConfig")]
    public interface IDefaultVpcDhcpOptionsConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDefaultVpcDhcpOptionsConfig), fullyQualifiedName: "aws.DefaultVpcDhcpOptionsConfig")]
        internal sealed class _Proxy : DeputyBase, aws.IDefaultVpcDhcpOptionsConfig
        {
