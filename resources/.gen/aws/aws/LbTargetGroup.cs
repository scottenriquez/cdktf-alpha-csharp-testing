...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.LbTargetGroup), fullyQualifiedName: "aws.LbTargetGroup", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"optional\":true,\"type\":{\"fqn\":\"aws.LbTargetGroupConfig\"}}]")]
    public class LbTargetGroup : HashiCorp.Cdktf.TerraformResource
    {
        public LbTargetGroup(Constructs.Construct scope, string id, aws.ILbTargetGroupConfig? config = null): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "healthCheckInput", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.LbTargetGroupHealthCheck\"},\"kind\":\"array\"}}", isOptional: true)]
        public virtual aws.ILbTargetGroupHealthCheck[]? HealthCheckInput
        {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "stickinessInput", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.LbTargetGroupStickiness\"},\"kind\":\"array\"}}", isOptional: true)]
        public virtual aws.ILbTargetGroupStickiness[]? StickinessInput
        {
        ...
        [JsiiProperty(name: "healthCheck", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.LbTargetGroupHealthCheck\"},\"kind\":\"array\"}}")]
        public virtual aws.ILbTargetGroupHealthCheck[] HealthCheck
        {
            get => GetInstanceProperty<aws.ILbTargetGroupHealthCheck[]>()!;
            set => SetInstanceProperty(value);
        }
        ...
        [JsiiProperty(name: "stickiness", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.LbTargetGroupStickiness\"},\"kind\":\"array\"}}")]
        public virtual aws.ILbTargetGroupStickiness[] Stickiness
        {
            get => GetInstanceProperty<aws.ILbTargetGroupStickiness[]>()!;
            set => SetInstanceProperty(value);
        }
