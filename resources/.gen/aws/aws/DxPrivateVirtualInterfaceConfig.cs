...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.DxPrivateVirtualInterfaceConfig")]
    public class DxPrivateVirtualInterfaceConfig : aws.IDxPrivateVirtualInterfaceConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.DxPrivateVirtualInterfaceTimeouts\"}", isOptional: true, isOverride: true)]
