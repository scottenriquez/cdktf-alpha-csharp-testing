...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.CloudformationStackSetConfig")]
    public class CloudformationStackSetConfig : aws.ICloudformationStackSetConfig
    {
        [JsiiProperty(name: "administrationRoleArn", typeJson: "{\"primitive\":\"string\"}", isOverride: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.CloudformationStackSetTimeouts\"}", isOptional: true, isOverride: true)]
