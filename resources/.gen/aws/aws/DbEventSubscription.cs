...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.DbEventSubscription), fullyQualifiedName: "aws.DbEventSubscription", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.DbEventSubscriptionConfig\"}}]")]
    public class DbEventSubscription : HashiCorp.Cdktf.TerraformResource
    {
        public DbEventSubscription(Constructs.Construct scope, string id, aws.IDbEventSubscriptionConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        [JsiiProperty(name: "snsTopicInput", typeJson: "{\"primitive\":\"string\"}")]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "timeoutsInput", typeJson: "{\"fqn\":\"aws.DbEventSubscriptionTimeouts\"}", isOptional: true)]
        public virtual aws.IDbEventSubscriptionTimeouts? TimeoutsInput
        {
            get => GetInstanceProperty<aws.IDbEventSubscriptionTimeouts?>();
        }
        ...
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.DbEventSubscriptionTimeouts\"}")]
        public virtual aws.IDbEventSubscriptionTimeouts Timeouts
        {
            get => GetInstanceProperty<aws.IDbEventSubscriptionTimeouts>()!;
            set => SetInstanceProperty(value);
        }
