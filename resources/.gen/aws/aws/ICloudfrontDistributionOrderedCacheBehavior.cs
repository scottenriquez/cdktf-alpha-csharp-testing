...
namespace aws
{
    [JsiiInterface(nativeType: typeof(ICloudfrontDistributionOrderedCacheBehavior), fullyQualifiedName: "aws.CloudfrontDistributionOrderedCacheBehavior")]
    public interface ICloudfrontDistributionOrderedCacheBehavior
    {
        ...
        [JsiiProperty(name: "forwardedValues", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.CloudfrontDistributionOrderedCacheBehaviorForwardedValues\"},\"kind\":\"array\"}}")]
        aws.ICloudfrontDistributionOrderedCacheBehaviorForwardedValues[] ForwardedValues
        {
            get;
        }
        ...
        [JsiiProperty(name: "lambdaFunctionAssociation", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.CloudfrontDistributionOrderedCacheBehaviorLambdaFunctionAssociation\"},\"kind\":\"array\"}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.ICloudfrontDistributionOrderedCacheBehaviorLambdaFunctionAssociation[]? LambdaFunctionAssociation
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(ICloudfrontDistributionOrderedCacheBehavior), fullyQualifiedName: "aws.CloudfrontDistributionOrderedCacheBehavior")]
        internal sealed class _Proxy : DeputyBase, aws.ICloudfrontDistributionOrderedCacheBehavior
        {
            ...
            {
                get => GetInstanceProperty<aws.ICloudfrontDistributionOrderedCacheBehaviorForwardedValues[]>()!;
            }
            ...
            {
                get => GetInstanceProperty<aws.ICloudfrontDistributionOrderedCacheBehaviorLambdaFunctionAssociation[]?>();
            }
