...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.TransferUser), fullyQualifiedName: "aws.TransferUser", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.TransferUserConfig\"}}]")]
    public class TransferUser : HashiCorp.Cdktf.TerraformResource
    {
        public TransferUser(Constructs.Construct scope, string id, aws.ITransferUserConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
