...
namespace aws
{
    [JsiiInterface(nativeType: typeof(IOpsworksMemcachedLayerConfig), fullyQualifiedName: "aws.OpsworksMemcachedLayerConfig")]
    public interface IOpsworksMemcachedLayerConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        [JsiiProperty(name: "ebsVolume", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.OpsworksMemcachedLayerEbsVolume\"},\"kind\":\"array\"}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.IOpsworksMemcachedLayerEbsVolume[]? EbsVolume
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IOpsworksMemcachedLayerConfig), fullyQualifiedName: "aws.OpsworksMemcachedLayerConfig")]
        internal sealed class _Proxy : DeputyBase, aws.IOpsworksMemcachedLayerConfig
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "ebsVolume", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.OpsworksMemcachedLayerEbsVolume\"},\"kind\":\"array\"}}", isOptional: true)]
            public aws.IOpsworksMemcachedLayerEbsVolume[]? EbsVolume
            {
