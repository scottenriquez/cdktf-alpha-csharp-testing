...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.EbsVolume), fullyQualifiedName: "aws.EbsVolume", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.EbsVolumeConfig\"}}]")]
    public class EbsVolume : HashiCorp.Cdktf.TerraformResource
    {
        public EbsVolume(Constructs.Construct scope, string id, aws.IEbsVolumeConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "multiAttachEnabledInput", typeJson: "{\"primitive\":\"boolean\"}", isOptional: true)]
        public virtual bool? MultiAttachEnabledInput
        {
            get => GetInstanceProperty<bool?>();
        }
