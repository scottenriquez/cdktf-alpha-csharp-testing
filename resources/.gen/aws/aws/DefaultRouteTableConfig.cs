...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.DefaultRouteTableConfig")]
    public class DefaultRouteTableConfig : aws.IDefaultRouteTableConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "route", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.DefaultRouteTableRoute\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
