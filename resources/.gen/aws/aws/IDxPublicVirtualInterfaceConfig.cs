...
namespace aws
{
    [JsiiInterface(nativeType: typeof(IDxPublicVirtualInterfaceConfig), fullyQualifiedName: "aws.DxPublicVirtualInterfaceConfig")]
    public interface IDxPublicVirtualInterfaceConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.DxPublicVirtualInterfaceTimeouts\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.IDxPublicVirtualInterfaceTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IDxPublicVirtualInterfaceConfig), fullyQualifiedName: "aws.DxPublicVirtualInterfaceConfig")]
        internal sealed class _Proxy : DeputyBase, aws.IDxPublicVirtualInterfaceConfig
        {
