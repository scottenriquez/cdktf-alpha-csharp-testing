...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.OpsworksCustomLayerConfig")]
    public class OpsworksCustomLayerConfig : aws.IOpsworksCustomLayerConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "ebsVolume", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.OpsworksCustomLayerEbsVolume\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
