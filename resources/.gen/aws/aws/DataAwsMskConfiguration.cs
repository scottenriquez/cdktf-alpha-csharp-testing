...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.DataAwsMskConfiguration), fullyQualifiedName: "aws.DataAwsMskConfiguration", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.DataAwsMskConfigurationConfig\"}}]")]
    public class DataAwsMskConfiguration : HashiCorp.Cdktf.TerraformDataSource
    {
        public DataAwsMskConfiguration(Constructs.Construct scope, string id, aws.IDataAwsMskConfigurationConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
