...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.EmrClusterInstanceGroup")]
    public class EmrClusterInstanceGroup : aws.IEmrClusterInstanceGroup
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "ebsConfig", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.EmrClusterInstanceGroupEbsConfig\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
