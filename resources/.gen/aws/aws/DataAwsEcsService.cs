...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.DataAwsEcsService), fullyQualifiedName: "aws.DataAwsEcsService", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.DataAwsEcsServiceConfig\"}}]")]
    public class DataAwsEcsService : HashiCorp.Cdktf.TerraformDataSource
    {
        public DataAwsEcsService(Constructs.Construct scope, string id, aws.IDataAwsEcsServiceConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        [JsiiProperty(name: "clusterArnInput", typeJson: "{\"primitive\":\"string\"}")]
