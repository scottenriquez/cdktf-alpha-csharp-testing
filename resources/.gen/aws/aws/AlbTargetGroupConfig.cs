...
namespace aws
{
    [JsiiByValue(fqn: "aws.AlbTargetGroupConfig")]
    public class AlbTargetGroupConfig : aws.IAlbTargetGroupConfig
    {
        [JsiiOptional]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "healthCheck", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.AlbTargetGroupHealthCheck\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "stickiness", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.AlbTargetGroupStickiness\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
