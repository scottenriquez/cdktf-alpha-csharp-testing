...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.WafRegexPatternSet), fullyQualifiedName: "aws.WafRegexPatternSet", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.WafRegexPatternSetConfig\"}}]")]
    public class WafRegexPatternSet : HashiCorp.Cdktf.TerraformResource
    {
        public WafRegexPatternSet(Constructs.Construct scope, string id, aws.IWafRegexPatternSetConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
