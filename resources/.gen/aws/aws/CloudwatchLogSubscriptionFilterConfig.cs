...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.CloudwatchLogSubscriptionFilterConfig")]
    public class CloudwatchLogSubscriptionFilterConfig : aws.ICloudwatchLogSubscriptionFilterConfig
    {
