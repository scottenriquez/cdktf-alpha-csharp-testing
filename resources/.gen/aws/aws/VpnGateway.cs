...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.VpnGateway), fullyQualifiedName: "aws.VpnGateway", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"optional\":true,\"type\":{\"fqn\":\"aws.VpnGatewayConfig\"}}]")]
    public class VpnGateway : HashiCorp.Cdktf.TerraformResource
    {
        public VpnGateway(Constructs.Construct scope, string id, aws.IVpnGatewayConfig? config = null): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
