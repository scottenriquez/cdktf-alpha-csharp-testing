...
namespace aws
{
    [JsiiClass(nativeType: typeof(aws.DxHostedPrivateVirtualInterface), fullyQualifiedName: "aws.DxHostedPrivateVirtualInterface", parametersJson: "[{\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.DxHostedPrivateVirtualInterfaceConfig\"}}]")]
    public class DxHostedPrivateVirtualInterface : HashiCorp.Cdktf.TerraformResource
    {
        public DxHostedPrivateVirtualInterface(Constructs.Construct scope, string id, aws.IDxHostedPrivateVirtualInterfaceConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        [JsiiProperty(name: "ownerAccountIdInput", typeJson: "{\"primitive\":\"string\"}")]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "timeoutsInput", typeJson: "{\"fqn\":\"aws.DxHostedPrivateVirtualInterfaceTimeouts\"}", isOptional: true)]
        public virtual aws.IDxHostedPrivateVirtualInterfaceTimeouts? TimeoutsInput
        {
            get => GetInstanceProperty<aws.IDxHostedPrivateVirtualInterfaceTimeouts?>();
        }
        ...
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.DxHostedPrivateVirtualInterfaceTimeouts\"}")]
        public virtual aws.IDxHostedPrivateVirtualInterfaceTimeouts Timeouts
        {
            get => GetInstanceProperty<aws.IDxHostedPrivateVirtualInterfaceTimeouts>()!;
            set => SetInstanceProperty(value);
        }
