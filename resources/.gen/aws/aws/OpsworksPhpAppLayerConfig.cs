...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.OpsworksPhpAppLayerConfig")]
    public class OpsworksPhpAppLayerConfig : aws.IOpsworksPhpAppLayerConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "ebsVolume", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.OpsworksPhpAppLayerEbsVolume\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
