...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.AlbListenerConfig")]
    public class AlbListenerConfig : aws.IAlbListenerConfig
    {
        /// <summary>default_action block.</summary>
        [JsiiProperty(name: "defaultAction", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.AlbListenerDefaultAction\"},\"kind\":\"array\"}}", isOverride: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.AlbListenerTimeouts\"}", isOptional: true, isOverride: true)]
