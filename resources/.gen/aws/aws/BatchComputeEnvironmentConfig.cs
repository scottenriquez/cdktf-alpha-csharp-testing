...
namespace aws
{
    ...
    [JsiiByValue(fqn: "aws.BatchComputeEnvironmentConfig")]
    public class BatchComputeEnvironmentConfig : aws.IBatchComputeEnvironmentConfig
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "computeResources", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"aws.BatchComputeEnvironmentComputeResources\"},\"kind\":\"array\"}}", isOptional: true, isOverride: true)]
